<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cad_estabelecimentos_usuarios.aspx.cs" Inherits="cad_estabelecimentos_usuarios" %>
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header bg-whitelabel1">
                        <h3 class="card-title">ESTABELECIMENTO USUÁRIOS</h3>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label>URL</label>
                                    <asp:TextBox runat="server" id="txtURL" cssClass="form-control" Visible="true" Enabled="false"></asp:TextBox>
                                </div>
                            </div>
                            ...
                            <asp:Repeater runat="server" ID="rptConsultaUsuario" 
                                ...
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="" onclick="javascript:openPopupWindow('cad_estabelecimentos_usuarios_perfil.aspx?id=<%# Funcoes.Encrypt(DataBinder.Eval(Container.DataItem,"COD_ID").ToString())%>', 'EstabelecimentosPerfil', 1024, 800); return false;" class="btn btn-sm btn-info">

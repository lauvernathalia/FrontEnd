<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cad_simular_venda.aspx.cs" Inherits="cad_simular_venda" %>
            ...
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p>Faça uma simulação para saber como ficarão as taxas de uma venda</p>
                        <div class="row">
                            <div class="col-sm-2">
                            ...
                            <div class="col-sm-10">
                                <div class="form-group">
                                    <label>Nome da Simulação de Venda</label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6"  >
                                ...
                                <asp:DropDownList runat="server" ID="ddlModalidade" CssClass="form-control">
                                    <asp:ListItem Text="Venda Presencial" Value="P"></asp:ListItem>
                                    <asp:ListItem Text="Venda On-line" Value="O"></asp:ListItem>
                                </asp:DropDownList>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6"  >
                                <div class="form-group">
                                <label>Qual é a bandeira para venda?</label>
                            ...
                            <div class="col-sm-6"  >
                                <div class="form-group">
                                <label>Qual é o valor da venda?</label>

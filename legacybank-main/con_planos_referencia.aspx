<%@ Page Language="C#" AutoEventWireup="true" CodeFile="con_planos_referencia.aspx.cs" Inherits="con_planos_referencia" %>
                        ...
                        <div class="row mb-2">
                          <div class="col-sm-12">
                            <ol class="breadcrumb">
                              ...
                              <li class="breadcrumb-item active">Planos Referência Adquirentes</li>
                            </ol>
                          </div>
                        </div>
                          ...
                          <div class="col-12">
                            <div class="card">
                              ...
                              <div class="card-header bg-whitelabel1">
                                <h3 class="card-title">PLANOS REFERÊNCIA ADQUIRENTES</h3>
                              </div>
                              <div class="card-body">
                                ...
                                <div class="form-group row col-12">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <asp:Button runat="server" ID="btnImportar" CssClass="btn btn-warning float-right" Text="Importar Planos Zoop" onclick="btnImportar_Click" Visible="false"/>
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <tr>
                                                      ...
                                                      <td>
                                                        ...
                                                        <a href="" onclick="javascript:openPopupWindow('cad_planos_referencia.aspx?id=<%#DataBinder.Eval(Container.DataItem,"COD_ID")%>', 'PlanosReferenciaEdicao', 1024, 800); return false;" class="btn btn-sm btn-app">

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cad_modelos_equipamentos.aspx.cs" Inherits="cad_modelos_equipamentos" %>
    ...
    <form id="frmPrincipal" runat="server">
        ...
        <div class="row">
            ...
            <div class="card">
                ...
                <h3 class="card-title">Modelos - Equipamentos</h3><br />
                ...
                <div class="row">
                    ...
                    <div class="col-sm-2">
                        <div class="form-group">
                            ...
                            <asp:TextBox id="txtCodigo" runat="server" class="form-control" placeholder="Código do Modelo"></asp:TextBox>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <asp:TextBox id="txtNome" runat="server" class="form-control" placeholder="Nome do Modelo"></asp:TextBox>
                        </div>
                    </div>
                    <div class="col-sm-3">
                        <div class="form-group">
                            <label class="col-sm-12 col-form-label">Descrição Modelo</label>
                            <asp:TextBox id="txtDescricao" runat="server" class="form-control" placeholder="Descrição Modelo"></asp:TextBox>
                        </div>
                    </div>
                    <div class="col-sm-2">
                        <div class="form-group">

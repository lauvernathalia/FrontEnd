<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cad_bandeiras_adm.aspx.cs" Inherits="cad_bandeiras_adm" %>
    ...
    <form id="frmPrincipal" runat="server">
        ...
        <div class="row">
            ...
            <div class="card">
                ...
                <h3 class="card-title">BANDEIRA</h3>
                </div>
                <div class="card-body">
                    ...
                    <div class="col-sm-8">
                        <div class="form-group">
                            ...
                            <asp:DropDownList runat="server" id="ddlTipo" CssClass="form-control">
                                <asp:ListItem Value="V">À Vista</asp:ListItem>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <asp:TextBox id="txtOrdem"  runat="server" class="form-control" 
                                placeholder="Ordem de Exibição"></asp:TextBox>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            <label class="col-sm-12 col-form-label">Imagem</label>
                            <asp:TextBox id="txtImagem" runat="server" class="form-control" placeholder="E-mail do Responsável"></asp:TextBox>
                            <div class="btn btn-default col-12 ">
                                <i class="fas fa-paperclip"></i> Anexo
                                <input type="file" name="attachment" runat="server" id="flAnexo" />
                            </div>
                        </div>
                    </div>
                </div>

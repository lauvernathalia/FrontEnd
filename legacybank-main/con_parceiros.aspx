<%@ Page Language="C#" AutoEventWireup="true" CodeFile="con_parceiros.aspx.cs" Inherits="con_parceiros" %>
                          ...
                          <div class="col-12">
                            ...
                            <div class="card">
                              ...
                              <div class="card-footer">
                                ...
                                <asp:Button runat="server" ID="btnNovo" CssClass="btn btn-whitelabel1 col-2" Text="Novo Parceiro" onclick="btnNovo_Click"/>
                                            ...
                                            <table id="tblConsulta" class="table table-bordered table-hover">
                                                ...
                                                <asp:Repeater runat="server" ID="rptConsulta" OnItemCommand="rptConsulta_OnItemCommand">
                                                    <ItemTemplate>
                                                        ...
                                                        <tr>
                                                          <td>
                                                            <a href="" onclick="javascript:openPopupWindow('cad_parceiros.aspx?id=<%#DataBinder.Eval(Container.DataItem,"COD_ID")%>', 'ParceirosEdicao', 1024, 800); return false;" class="btn btn-sm btn-info">
                                                                <i class="fas fa-edit"></i>
                                                            </a>
                                                          </td>

                                                          <td>
                                                              <small><strong><%# String.Format("{0:dd/MM/yyyy}",DataBinder.Eval(Container.DataItem, "DTA_DATA"))%></strong></small><br />
                                                          </td>

                                                          <td>
                                                              <small><strong><%# DataBinder.Eval(Container.DataItem, "COD_ID")%> </strong></small><br />
                                                          </td>

                                                          <td>
                                                              <small><strong><%# DataBinder.Eval(Container.DataItem, "FLG_TIPO_PESSOA")%> </strong></small><br />
                                                          </td>


                                                          <td>
                                                              <small><strong><%# DataBinder.Eval(Container.DataItem, "NOM_PARCEIRO")%></strong></small><br />
                                                          </td>

                                                          <td>
                                                              <small><strong><%# DataBinder.Eval(Container.DataItem, "NOM_DOCUMENTO")%></strong></small><br />
                                                          </td>
                                                          <td>
                                                              <small><strong><%# DataBinder.Eval(Container.DataItem, "FLG_NOM_ID_CADASTRO")%></strong></small><br />
                                                          </td>
                                                          <td>
                                                              <small><strong><%# DataBinder.Eval(Container.DataItem, "NOM_ID_CADASTRO")%></strong></small><br />
                                                          </td>

                                                          <td>
                                                              <small><strong><%# DataBinder.Eval(Container.DataItem, "NOM_FANTASIA_INTEGRACAO")%></strong></small><br />
                                                          </td>

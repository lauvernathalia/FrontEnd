<%@ Page Language="C#" AutoEventWireup="true" CodeFile="con_planos_referencia_adm.aspx.cs" Inherits="con_planos_referencia_adm" %>
                              ...
                              <div class="card-body">
                                ...
                                <div class="form-group row col-12">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <asp:Button runat="server" ID="btnImportar" CssClass="btn btn-warning float-right" Text="Importar Planos Zoop" onclick="btnImportar_Click"/>
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <tr>
                                                      ...
                                                      <td>
                                                        ...
                                                        <a href="" onclick="javascript:openPopupWindow('cad_planos_referencia_adm.aspx?id=<%#DataBinder.Eval(Container.DataItem,"COD_ID")%>', 'PlanosReferenciaEdicao', 1024, 800); return false;" class="btn btn-sm btn-app">

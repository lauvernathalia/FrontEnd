<%@ Page Language="C#" AutoEventWireup="true" CodeFile="boletocarne.aspx.cs" Inherits="boletocarne" %>
...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <center>
    <button class="btn btn-outline-secondary mb-3 mt-2" onclick="printDiv('dvReciboEstabelecimento')"><i class="fas fa-print" aria-hidden="true"></i>     Imprimir carnê</button>
    </center>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cad_suporte.aspx.cs" Inherits="cad_suporte" %>
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header bg-whitelabel1">
                        <h3 class="card-title">SUPORTE SOLICITAÇÃO</h3>
                    </div>
                    <div class="card-body">
                        <h3><span class="float-center badge bg-whitelabel1">Dados da Solicitação</span></h3>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                <div class="form-group">
                                    <label>Status</label>
                                    <asp:DropDownList runat="server" ID="ddlStatus" CssClass="form-control"  Enabled="false">
                                        <asp:ListItem Value="P">Pendente</asp:ListItem>
                                        <asp:ListItem Value="R">Resolvido</asp:ListItem>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <asp:DropDownList runat="server" ID="ddlSolicitante" CssClass="form-control">
                                    </asp:DropDownList>                                
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label class="col-sm-12 col-form-label">Motivo</label>
                                    <asp:DropDownList runat="server" ID="ddlMotivo" CssClass="form-control">
                                    </asp:DropDownList>                                
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label class="col-sm-12 col-form-label">Suporte</label>
                                    <asp:TextBox id="txtSuporte" runat="server" CssClass="form-control" ></asp:TextBox>

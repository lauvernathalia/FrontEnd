<%@ Page Language="C#" AutoEventWireup="true" CodeFile="con_planos.aspx.cs" Inherits="con_planos" %>
                              ...
                              <div class="card-body">
                                ...
                                <div class="form-group row col-12">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <asp:Button runat="server" ID="btnImportarPlanos" CssClass="btn btn-warning float-right" Text="Importar Planos" onclick="btnImportarPlanos_Click"/>

                                        <asp:Button runat="server" ID="btnNovo" CssClass="btn btn-whitelabel1 float-right" Text="(+) Novo Plano" onclick="btnNovo_Click"/>
                                            ...
                                            <asp:Repeater runat="server" ID="rptConsulta" OnItemCommand="rptConsulta_OnItemCommand">
                                                <ItemTemplate>
                                                    ...
                                                    <tr>
                                                      ...
                                                      <td>
                                                        <a href="" onclick="javascript:openPopupWindow('cad_planos.aspx?id=<%# Funcoes.Encrypt(DataBinder.Eval(Container.DataItem,"COD_ID").ToString())%>', 'PlanosEdicao', 1024, 800); return false;" class="btn btn-sm btn-app">
                                                            <i class="fas fa-edit"></i> Editar
                                                        </a>                                                      
                                                      </td>

                                                      <td>
                                                          <small><%# DataBinder.Eval(Container.DataItem, "NOM_FLG_MODELO_PLANO")%></small>
                                                      </td>

                                                      <td>
                                                        <a href="" onclick="javascript:openPopupWindow('cad_planos.aspx?id=<%# Funcoes.Encrypt(DataBinder.Eval(Container.DataItem,"COD_ID").ToString())%>', 'PlanosEdicao', 1024, 800); return false;">
                                                          <small><strong><%# DataBinder.Eval(Container.DataItem, "NOM_TITULO_PLANO")%></strong></small><br />
				                						</a>
                                                      </td>
                                                      <td>
                                                          <small><%# DataBinder.Eval(Container.DataItem, "DES_PLANO")%></small>
                                                      </td>
                                                      <td>
                                                          <small><%# DataBinder.Eval(Container.DataItem, "NOM_FLG_VISIVEL")%></small>
                                                      </td>
                                                      <td>
                                                          <small><%# DataBinder.Eval(Container.DataItem, "NUM_DIAS_LIQUIDACAO")%></small>
                                                      </td>
                                                      <td>
                                                          <small><%# DataBinder.Eval(Container.DataItem, "NOM_FLG_ANTECIPADO")%></small>
                                                      </td>
                                                      <td>
                                                          <small><%# String.Format("{0:n2}",DataBinder.Eval(Container.DataItem, "NUM_TAXA_ANTECIPACAO"))%></small>
                                                      </td>
                                                      ...
                                                      <td>
                                                          <a class="btn btn-app" href="" onclick="javascript:openPopupWindow('con_planos_estabelecimentos.aspx?id=<%# Funcoes.Encrypt(DataBinder.Eval(Container.DataItem,"COD_ID").ToString())%>', 'PlanosEdicao', 1024, 800); return false;">                                                             
                                                          <%# DataBinder.Eval(Container.DataItem, "NUM_QTDE_PESSOAS_FJ")%>
                                                          <i class="fas fa-store-alt"></i> Estabelecimentos
                                                          </a>
                                                      </td>


                                                      <td>
                                                        <a href="" onclick="javascript:openPopupWindow('cad_planos_exportar.aspx?id=<%# Funcoes.Encrypt(DataBinder.Eval(Container.DataItem,"COD_ID").ToString())%>', 'PlanosExportar', 1024, 800); return false;" class="btn btn-sm btn-app">
                                                            <i class="fas fa-file-export"></i> Exportar
                                                        </a>                                                      
                                                      </td>

                                                      <td>
                                                          <asp:linkbutton ID="lkbExcluir" CssClass="btn btn-danger btn-sm" commandname="Excluir" runat="server" text="Excluir"  CommandArgument='<%# DataBinder.Eval(Container.DataItem, "COD_ID")%>' /><br />
                                                          <asp:TextBox runat="server" ID="txtPessoasPlanos" Text='<%# DataBinder.Eval(Container.DataItem, "NUM_PESSOAS_FJ_PLANO")%>' Visible="false"></asp:TextBox>
                                                      </td>
                                                    </tr>
                                                </ItemTemplate>
                                            </asp:Repeater>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cad_planos_referencia_adm.aspx.cs" Inherits="cad_planos_referencia_adm" %>
    ...
    <form id="frmPrincipal" runat="server">
        ...
        <div class="row">
            ...
            <div class="card">
                ...
                <h3 class="card-title">PLANOS DE REFERÊNCIA ADQUIRENTE</h3>
                </div>
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <asp:TextBox id="txtCodigo" runat="server" class="form-control" placeholder="Código de Referência"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group">
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <tr>
                                                      ...
                                                      <td>
                                                        ...
                                                        <td>
                                                            <small><asp:TextBox runat="server" id="txMarkup" Text='<%# String.Format("{0:n2}",DataBinder.Eval(Container.DataItem, "NUM_VALOR_MARKUP"))%>' class="form-control"></asp:TextBox></small>
                                                        </td>
                                                        <td>

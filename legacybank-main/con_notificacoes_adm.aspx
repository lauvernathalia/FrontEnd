<%@ Page Language="C#" AutoEventWireup="true" CodeFile="con_notificacoes_adm.aspx.cs" Inherits="con_notificacoes_adm" %>
                                            ...
                                            <asp:Repeater runat="server" ID="rptConsulta" OnItemCommand="rptConsulta_OnItemCommand">
                                                <ItemTemplate>
                                                    ...
                                                    <tr>
                                                      ...
                                                      <td>
                                                          <small><%# DataBinder.Eval(Container.DataItem, "NOM_TYPE")%></small>
                                                      </td>
                                                      <td>
                                                          <small><%# DataBinder.Eval(Container.DataItem, "NOM_RAZAOSOCIAL")%></small>
                                                      </td>
                                                      <td>
                                                          <small><%# DataBinder.Eval(Container.DataItem, "FLG_PROCESSADO")%></small>
                                                      </td>

                                                      <td>

                                                        <a href="" onclick="javascript:openPopupWindow('cad_notificacoes_adm.aspx?id=<%#DataBinder.Eval(Container.DataItem,"COD_ID")%>', 'Notificacoes', 1024, 800); return false;" class="btn btn-sm btn-app">

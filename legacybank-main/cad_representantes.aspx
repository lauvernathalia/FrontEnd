<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cad_representantes.aspx.cs" Inherits="cad_representantes" Async="true" EnableSessionState="ReadOnly" MaintainScrollPositionOnPostback="true" %>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <h3><span class="float-center badge bg-whitelabel1">1. Dados do Representante</span></h3>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <asp:DropDownList runat="server" id="ddlTipoFJ" CssClass="form-control" 
                                        AutoPostBack="True" onselectedindexchanged="ddlTipoFJ_SelectedIndexChanged1">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                <label>Você visitou este representante presencialmente?<strong class="text-danger">*</strong></label>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cad_compradores.aspx.cs" Inherits="cad_compradores" %>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <h3><span class="float-center badge bg-whitelabel1">Dados do Comprador</span></h3>
                        ...
                        <h3><span class="float-center badge bg-whitelabel1">1. Comprador</span></h3>
                        ...
                        <h3><span class="float-center badge bg-whitelabel1">2. Endereço</span></h3>

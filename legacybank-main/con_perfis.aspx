<%@ Page Language="C#" AutoEventWireup="true" CodeFile="con_perfis.aspx.cs" Inherits="con_perfis" %>
                              ...
                              <div class="card-body">
                                ...
                                <div class="form-group row col-12">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <asp:Button runat="server" ID="btnNovo" CssClass="btn btn-whitelabel1 float-right" Text="(+) Novo Perfil" onclick="btnNovo_Click"/>
                                            ...
                                            <asp:Repeater runat="server" ID="rptConsulta" OnItemCommand="rptConsulta_OnItemCommand">
                                                <ItemTemplate>
                                                    <tr>
                                                      ...
                                                      <td>
                                                        <a href="" onclick="javascript:openPopupWindow('cad_perfis.aspx?id=<%#DataBinder.Eval(Container.DataItem,"COD_ID")%>', 'PerfisEdicao', 1024, 800); return false;" class="btn btn-sm btn-info">
                                                            <i class="fas fa-edit"></i>
                                                        </a>
                                                      </td>

                                                      <td>
                                                          <small><%# DataBinder.Eval(Container.DataItem, "NOM_PERFIL")%></small>
                                                      </td>
                                                      <td>
                                                      ...
                                                      <td>
                                                        <a href="" onclick="javascript:openPopupWindow('cad_perfis_acessos.aspx?id=<%#DataBinder.Eval(Container.DataItem,"COD_ID")%>', 'PerfisAcessos', 1024, 800); return false;" class="btn btn-sm btn-info">
                                                            <i class="fas fa-users"></i>
                                                        </a>
                                                      </td>
                                                      <td>
                                                        <a href="" onclick="javascript:openPopupWindow('cad_perfis_comercial.aspx?id=<%#DataBinder.Eval(Container.DataItem,"COD_ID")%>', 'PerfisComercial', 1024, 800); return false;" class="btn btn-sm btn-info">

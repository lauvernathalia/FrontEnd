<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cad_planos_mkt.aspx.cs" Inherits="cad_planos_mkt" %>
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <tr>
                                                ...
                                                <asp:TextBox runat="server" id="txtidplanoreferencia" Text='<%# DataBinder.Eval(Container.DataItem, "COD_ID_PLANOS_REFERENCIA")%>' visible="false"></asp:TextBox>
                                                    ...
                                                    <small><strong>Markup</strong></small><br />
                                                    <small><strong>Rebote</strong></small><br />
                                                    <small><strong>Tx.Final</strong></small>

                                                </td>

                                                <td class="text-center" style="min-width:90px;" >
                                                    <small><strong><asp:TextBox runat="server" CssClass="form-control" id="txtdebito" Text='<%# String.Format("{0:n2}",DataBinder.Eval(Container.DataItem, "NUM_VALOR_DEBITO"))%>' Enabled="false"></asp:TextBox></strong></small><br />
                                                    ...
                                                    <small><strong><asp:TextBox runat="server" CssClass="form-control" id="txtrebatedebito" Text='<%# String.Format("{0:n2}",DataBinder.Eval(Container.DataItem, "NUM_VALOR_REBATE_DEBITO"))%>'></asp:TextBox></strong></small>
                                                ...
                                                <td class="text-center" style="min-width:90px;" >
                                                    <small><strong><asp:TextBox runat="server" CssClass="form-control" id="txtcredito" Text='<%# String.Format("{0:n2}",DataBinder.Eval(Container.DataItem, "NUM_VALOR_CREDITO_VISTA"))%>' Enabled="false" ></asp:TextBox></strong></small><br />
                                                    ...
                                                    <small><strong><asp:TextBox runat="server" CssClass="form-control" id="txtrebatevista" Text='<%# String.Format("{0:n2}",DataBinder.Eval(Container.DataItem, "NUM_VALOR_REBATE_VISTA"))%>'></asp:TextBox></strong></small><br />
                                                ...
                                                <td class="text-center" style="min-width:90px;" >
                                                    <small><strong><asp:TextBox runat="server" CssClass="form-control" id="txtcredito2x" Text='<%# String.Format("{0:n2}",DataBinder.Eval(Container.DataItem, "NUM_VALOR_CREDITO_2X"))%>' Enabled="false"></asp:TextBox></strong></small><br />
                                                    ...
                                                    <small><strong><asp:TextBox runat="server" CssClass="form-control" id="txtrebate2x" Text='<%# String.Format("{0:n2}",DataBinder.Eval(Container.DataItem, "NUM_VALOR_REBATE_2X"))%>'></asp:TextBox></strong></small><br />
                                                ...
                                                <td class="text-center" style="min-width:90px;" >
                                                    <small><strong><asp:TextBox runat="server" CssClass="form-control" id="txtcredito3x" Text='<%# String.Format("{0:n2}",DataBinder.Eval(Container.DataItem, "NUM_VALOR_CREDITO_3X"))%>' Enabled="false"></asp:TextBox></strong></small><br />
                                                    ...
                                                    <small><strong><asp:TextBox runat="server" CssClass="form-control" id="txtrebate3x" Text='<%# String.Format("{0:n2}",DataBinder.Eval(Container.DataItem, "NUM_VALOR_REBATE_3X"))%>'></asp:TextBox></strong></small><br />
                                                ...
                                                <td class="text-center" style="min-width:90px;" >
                                                    <small><strong><asp:TextBox runat="server" CssClass="form-control" id="txtcredito4x" Text='<%# String.Format("{0:n2}",DataBinder.Eval(Container.DataItem, "NUM_VALOR_CREDITO_4X"))%>' Enabled="false"></asp:TextBox></strong></small><br />
                                                    <small><strong><asp:TextBox runat="server" CssClass="form-control" id="txtmarkup4x" Text='<%# String.Format("{0:n2}",DataBinder.Eval(Container.DataItem, "NUM_VALOR_MARKUP_4X"))%>'></asp:TextBox></strong></small>
                                                    <small><strong><asp:TextBox runat="server" CssClass="form-control" id="txtrebate4x" Text='<%# String.Format("{0:n2}",DataBinder.Eval(Container.DataItem, "NUM_VALOR_REBATE_4X"))%>'></asp:TextBox></strong></small><br />
                                                ...
                                                <td class="text-center" style="min-width:90px;" >
                                                    <small><strong><asp:TextBox runat="server" CssClass="form-control" id="txtcredito5x" Text='<%# String.Format("{0:n2}",DataBinder.Eval(Container.DataItem, "NUM_VALOR_CREDITO_5X"))%>' Enabled="false"></asp:TextBox></strong></small><br />
                                                    <small><strong><asp:TextBox runat="server" CssClass="form-control" id="txtmarkup5x" Text='<%# String.Format("{0:n2}",DataBinder.Eval(Container.DataItem, "NUM_VALOR_MARKUP_5X"))%>'></asp:TextBox></strong></small>
                                                    <small><strong><asp:TextBox runat="server" CssClass="form-control" id="txtrebate5x" Text='<%# String.Format("{0:n2}",DataBinder.Eval(Container.DataItem, "NUM_VALOR_REBATE_5X"))%>'></asp:TextBox></strong></small><br />
                                                ...
                                                <td class="text-center" style="min-width:90px;" >
                                                    <small><strong><asp:TextBox runat="server" CssClass="form-control" id="txtcredito6x" Text='<%# String.Format("{0:n2}",DataBinder.Eval(Container.DataItem, "NUM_VALOR_CREDITO_6X"))%>' Enabled="false"></asp:TextBox></strong></small><br />
                                                    <small><strong><asp:TextBox runat="server" CssClass="form-control" id="txtmarkup6x" Text='<%# String.Format("{0:n2}",DataBinder.Eval(Container.DataItem, "NUM_VALOR_MARKUP_6X"))%>'></asp:TextBox></strong></small>
                                                    <small><strong><asp:TextBox runat="server" CssClass="form-control" id="txtrebate6x" Text='<%# String.Format("{0:n2}",DataBinder.Eval(Container.DataItem, "NUM_VALOR_REBATE_6X"))%>'></asp:TextBox></strong></small><br />
                                                ...
                                                <td class="text-center" style="min-width:90px;" >
                                                    <small><strong><asp:TextBox runat="server" CssClass="form-control" id="txtcredito7x" Text='<%# String.Format("{0:n2}",DataBinder.Eval(Container.DataItem, "NUM_VALOR_CREDITO_7X"))%>' Enabled="false"></asp:TextBox></strong></small><br />
                                                    <small><strong><asp:TextBox runat="server" CssClass="form-control" id="txtmarkup7x" Text='<%# String.Format("{0:n2}",DataBinder.Eval(Container.DataItem, "NUM_VALOR_MARKUP_7X"))%>'></asp:TextBox></strong></small>
                                                    <small><strong><asp:TextBox runat="server" CssClass="form-control" id="txtrebate7x" Text='<%# String.Format("{0:n2}",DataBinder.Eval(Container.DataItem, "NUM_VALOR_REBATE_7X"))%>'></asp:TextBox></strong></small><br />
                                                ...
                                                <td class="text-center" style="min-width:90px;" >
                                                    <small><strong><asp:TextBox runat="server" CssClass="form-control" id="txtcredito8x" Text='<%# String.Format("{0:n2}",DataBinder.Eval(Container.DataItem, "NUM_VALOR_CREDITO_8X"))%>' Enabled="false"></asp:TextBox></strong></small><br />
                                                    <small><strong><asp:TextBox runat="server" CssClass="form-control" id="txtmarkup8x" Text='<%# String.Format("{0:n2}",DataBinder.Eval(Container.DataItem, "NUM_VALOR_MARKUP_8X"))%>'></asp:TextBox></strong></small>
                                                    <small><strong><asp:TextBox runat="server" CssClass="form-control" id="txtrebate8x" Text='<%# String.Format("{0:n2}",DataBinder.Eval(Container.DataItem, "NUM_VALOR_REBATE_8X"))%>'></asp:TextBox></strong></small><br />
                                                ...
                                                <td class="text-center" style="min-width:90px;" >
                                                    <small><strong><asp:TextBox runat="server" CssClass="form-control" id="txtcredito9x" Text='<%# String.Format("{0:n2}",DataBinder.Eval(Container.DataItem, "NUM_VALOR_CREDITO_9X"))%>' Enabled="false"></asp:TextBox></strong></small><br />
                                                    <small><strong><asp:TextBox runat="server" CssClass="form-control" id="txtmarkup9x" Text='<%# String.Format("{0:n2}",DataBinder.Eval(Container.DataItem, "NUM_VALOR_MARKUP_9X"))%>'></asp:TextBox></strong></small>
                                                    <small><strong><asp:TextBox runat="server" CssClass="form-control" id="txtrebate9x" Text='<%# String.Format("{0:n2}",DataBinder.Eval(Container.DataItem, "NUM_VALOR_REBATE_9X"))%>'></asp:TextBox></strong></small><br />
                                                ...
                                                <td class="text-center" style="min-width:90px;" >
                                                    <small><strong><asp:TextBox runat="server" CssClass="form-control" id="txtcredito10x" Text='<%# String.Format("{0:n2}",DataBinder.Eval(Container.DataItem, "NUM_VALOR_CREDITO_10X"))%>' Enabled="false"></asp:TextBox></strong></small><br />
                                                    <small><strong><asp:TextBox runat="server" CssClass="form-control" id="txtmarkup10x" Text='<%# String.Format("{0:n2}",DataBinder.Eval(Container.DataItem, "NUM_VALOR_MARKUP_10X"))%>'></asp:TextBox></strong></small>
                                                    <small><strong><asp:TextBox runat="server" CssClass="form-control" id="txtrebate10x" Text='<%# String.Format("{0:n2}",DataBinder.Eval(Container.DataItem, "NUM_VALOR_REBATE_10X"))%>'></asp:TextBox></strong></small><br />
                                                ...
                                                <td class="text-center" style="min-width:90px;" >
                                                    <small><strong><asp:TextBox runat="server" CssClass="form-control" id="txtcredito11x" Text='<%# String.Format("{0:n2}",DataBinder.Eval(Container.DataItem, "NUM_VALOR_CREDITO_11X"))%>' Enabled="false"></asp:TextBox></strong></small><br />
                                                    <small><strong><asp:TextBox runat="server" CssClass="form-control" id="txtmarkup11x" Text='<%# String.Format("{0:n2}",DataBinder.Eval(Container.DataItem, "NUM_VALOR_MARKUP_11X"))%>'></asp:TextBox></strong></small>
                                                    <small><strong><asp:TextBox runat="server" CssClass="form-control" id="txtrebate11x" Text='<%# String.Format("{0:n2}",DataBinder.Eval(Container.DataItem, "NUM_VALOR_REBATE_11X"))%>'></asp:TextBox></strong></small><br />
                                                ...
                                                <td class="text-center" style="min-width:90px;" >
                                                    <small><strong><asp:TextBox runat="server" CssClass="form-control" id="txtcredito12x" Text='<%# String.Format("{0:n2}",DataBinder.Eval(Container.DataItem, "NUM_VALOR_CREDITO_12X"))%>' Enabled="false"></asp:TextBox></strong></small><br />
                                                    <small><strong><asp:TextBox runat="server" CssClass="form-control" id="txtmarkup12x" Text='<%# String.Format("{0:n2}",DataBinder.Eval(Container.DataItem, "NUM_VALOR_MARKUP_12X"))%>'></asp:TextBox></strong></small>
                                                    <small><strong><asp:TextBox runat="server" CssClass="form-control" id="txtrebate12x" Text='<%# String.Format("{0:n2}",DataBinder.Eval(Container.DataItem, "NUM_VALOR_REBATE_12X"))%>'></asp:TextBox></strong></small><br />
                                                ...
                                                <td class="text-center" style="min-width:90px;" >
                                                    <small><strong><asp:TextBox runat="server" CssClass="form-control" id="txtcredito13x" Text='<%# String.Format("{0:n2}",DataBinder.Eval(Container.DataItem, "NUM_VALOR_CREDITO_13X"))%>' Enabled="false"></asp:TextBox></strong></small><br />
                                                    <small><strong><asp:TextBox runat="server" CssClass="form-control" id="txtmarkup13x" Text='<%# String.Format("{0:n2}",DataBinder.Eval(Container.DataItem, "NUM_VALOR_MARKUP_13X"))%>'></asp:TextBox></strong></small>
                                                    <small><strong><asp:TextBox runat="server" CssClass="form-control" id="txtrebate13x" Text='<%# String.Format("{0:n2}",DataBinder.Eval(Container.DataItem, "NUM_VALOR_REBATE_13X"))%>'></asp:TextBox></strong></small><br />
                                                ...
                                                <td class="text-center" style="min-width:90px;" >
                                                    <small><strong><asp:TextBox runat="server" CssClass="form-control" id="txtcredito14x" Text='<%# String.Format("{0:n2}",DataBinder.Eval(Container.DataItem, "NUM_VALOR_CREDITO_14X"))%>' Enabled="false"></asp:TextBox></strong></small><br />
                                                    <small><strong><asp:TextBox runat="server" CssClass="form-control" id="txtmarkup14x" Text='<%# String.Format("{0:n2}",DataBinder.Eval(Container.DataItem, "NUM_VALOR_MARKUP_14X"))%>'></asp:TextBox></strong></small>
                                                    <small><strong><asp:TextBox runat="server" CssClass="form-control" id="txtrebate14x" Text='<%# String.Format("{0:n2}",DataBinder.Eval(Container.DataItem, "NUM_VALOR_REBATE_14X"))%>'></asp:TextBox></strong></small><br />
                                                ...
                                                <td class="text-center" style="min-width:90px;" >
                                                    <small><strong><asp:TextBox runat="server" CssClass="form-control" id="txtcredito15x" Text='<%# String.Format("{0:n2}",DataBinder.Eval(Container.DataItem, "NUM_VALOR_CREDITO_15X"))%>' Enabled="false"></asp:TextBox></strong></small><br />
                                                    <small><strong><asp:TextBox runat="server" CssClass="form-control" id="txtmarkup15x" Text='<%# String.Format("{0:n2}",DataBinder.Eval(Container.DataItem, "NUM_VALOR_MARKUP_15X"))%>'></asp:TextBox></strong></small>
                                                    <small><strong><asp:TextBox runat="server" CssClass="form-control" id="txtrebate15x" Text='<%# String.Format("{0:n2}",DataBinder.Eval(Container.DataItem, "NUM_VALOR_REBATE_15X"))%>'></asp:TextBox></strong></small><br />
                                                ...
                                                <td class="text-center" style="min-width:90px;" >
                                                    <small><strong><asp:TextBox runat="server" CssClass="form-control" id="txtcredito16x" Text='<%# String.Format("{0:n2}",DataBinder.Eval(Container.DataItem, "NUM_VALOR_CREDITO_16X"))%>' Enabled="false"></asp:TextBox></strong></small><br />
                                                    <small><strong><asp:TextBox runat="server" CssClass="form-control" id="txtmarkup16x" Text='<%# String.Format("{0:n2}",DataBinder.Eval(Container.DataItem, "NUM_VALOR_MARKUP_16X"))%>'></asp:TextBox></strong></small>
                                                    <small><strong><asp:TextBox runat="server" CssClass="form-control" id="txtrebate16x" Text='<%# String.Format("{0:n2}",DataBinder.Eval(Container.DataItem, "NUM_VALOR_REBATE_16X"))%>'></asp:TextBox></strong></small><br />
                                                ...
                                                <td class="text-center" style="min-width:90px;" >
                                                    <small><strong><asp:TextBox runat="server" CssClass="form-control" id="txtcredito17x" Text='<%# String.Format("{0:n2}",DataBinder.Eval(Container.DataItem, "NUM_VALOR_CREDITO_17X"))%>' Enabled="false"></asp:TextBox></strong></small><br />
                                                    <small><strong><asp:TextBox runat="server" CssClass="form-control" id="txtmarkup17x" Text='<%# String.Format("{0:n2}",DataBinder.Eval(Container.DataItem, "NUM_VALOR_MARKUP_17X"))%>'></asp:TextBox></strong></small>
                                                    <small><strong><asp:TextBox runat="server" CssClass="form-control" id="txtrebate17x" Text='<%# String.Format("{0:n2}",DataBinder.Eval(Container.DataItem, "NUM_VALOR_REBATE_17X"))%>'></asp:TextBox></strong></small><br />
                                                ...
                                                <td class="text-center" style="min-width:90px;" >
                                                    <small><strong><asp:TextBox runat="server" CssClass="form-control" id="txtcredito18x" Text='<%# String.Format("{0:n2}",DataBinder.Eval(Container.DataItem, "NUM_VALOR_CREDITO_18X"))%>' Enabled="false"></asp:TextBox></strong></small><br />
                                                    <small><strong><asp:TextBox runat="server" CssClass="form-control" id="txtmarkup18x" Text='<%# String.Format("{0:n2}",DataBinder.Eval(Container.DataItem, "NUM_VALOR_MARKUP_18X"))%>'></asp:TextBox></strong></small>
                                                    <small><strong><asp:TextBox runat="server" CssClass="form-control" id="txtrebate18x" Text='<%# String.Format("{0:n2}",DataBinder.Eval(Container.DataItem, "NUM_VALOR_REBATE_18X"))%>'></asp:TextBox></strong></small><br />

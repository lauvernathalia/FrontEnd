<%@ Page Language="C#" AutoEventWireup="true" CodeFile="con_mcc_adm.aspx.cs" Inherits="con_mcc_adm" %>
                            ...
                            <div class="card card-success">
                              ...
                              <div class="card-body">
                                ...
                                <div class="form-group row col-12">
                                    <div class="col-sm-4">
                                        <label class="col-sm-2 col-form-label">MCC</label>
                                ...
                                <div class="form-group row col-12">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <asp:Button runat="server" ID="btnCarregar" CssClass="btn btn-info float-right" Text="Carregar Tabela MCC" onclick="btnCarregar_Click"/>
                                            ...
                                            <asp:Repeater runat="server" ID="rptConsulta">
                                                <ItemTemplate>
                                                    ...
                                                    <tr>
                                                      ...
                                                      <td>
                                                          <small><%# DataBinder.Eval(Container.DataItem, "NOM_MCC")%></small>
                                                      </td>
                                                    </tr>
                                                </ItemTemplate>
                                            </asp:Repeater>

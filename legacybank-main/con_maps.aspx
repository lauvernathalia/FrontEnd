<%@ Page Language="C#" AutoEventWireup="true" CodeFile="con_maps.aspx.cs" Inherits="con_maps" %>
            ...
            <div class="card bg-gradient-success">
              <div class="card-header border-0">
                ...
                <div class="card-tools">
                  ...
                  <div class="btn-group">
                    <button type="button" class="btn btn-whitelabel1 btn-sm dropdown-toggle" data-toggle="dropdown">
                  ...
                  <button type="button" class="btn btn-whitelabel1 btn-sm" data-card-widget="collapse">
                    <i class="fas fa-minus"></i>
                  </button>
                  <button type="button" class="btn btn-whitelabel1 btn-sm" data-card-widget="remove">
                    <i class="fas fa-times"></i>
                  </button>
                </div>
                <!-- /. tools -->

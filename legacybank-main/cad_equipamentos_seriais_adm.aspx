<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cad_equipamentos_seriais_adm.aspx.cs" Inherits="cad_equipamentos_seriais_adm" %>
    ...
    <form id="frmPrincipal" runat="server">
        ...
        <div class="row">
            ...
            <div class="card">
                ...
                <h3 class="card-title">Equipamentos - Seriais</h3><br />
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <asp:TextBox id="txtToken" runat="server" class="form-control" placeholder="Token do Equipamento"></asp:TextBox>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label class="col-sm-12 col-form-label">Serial</label>
                            <asp:TextBox id="txtSerial" runat="server" class="form-control" placeholder="Serial do Equipamento"></asp:TextBox>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header bg-whitelabel1">
                        <h3 class="card-title">SERIAIS IMPORTAR</h3>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="tab-pane fade" runat="server" id="tbcappta" role="tabpanel" aria-labelledby="tbcapptatab">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table id="tblSeriais" class="table table-bordered table-hover">
                                            <thead>
                                            <tr>
                                                <th>Importar</th>
                                                <th>ID</th>
                                            ...
                                            <tbody>
                                                <asp:ListView ID="lsvSeriais" runat="server" 
                                                    OnItemCommand="lsvSeriais_ItemCommand">
                                                    <ItemTemplate>
                                                            <tr>
                                                                <td>
                                                                ...
                                                                <td>
                                                                    <small><asp:Label ID="Label3" runat="server" Text='<%# Eval("id") %>'></asp:Label></small>
                                                                    <asp:TextBox runat="server" ID="txtID" Text='<%# Eval("id") %>' Visible="false"></asp:TextBox>
                                                                </td>

                                                                <td>
                                                                    <small><asp:Label ID="Label6" runat="server" Text='<%# Eval("serial") %>'></asp:Label></small>
                                                                    <asp:TextBox runat="server" ID="txtSerial" Text='<%# Eval("serial") %>' Visible="false"></asp:TextBox>
                                                                </td>

                                                                <td>
                                                                    <small><asp:Label ID="Label2" runat="server" Text='<%# Eval("modelo") %>'></asp:Label></small>
                                                                    <asp:TextBox runat="server" ID="txtModelo" Text='<%# Eval("modelo") %>' Visible="false"></asp:TextBox>
                                                                </td>

                                                                <td>
                                                                    <small><asp:Label ID="Label16" runat="server" Text='<%# Eval("marketplace") %>'></asp:Label></small>
                                                                    <asp:TextBox runat="server" ID="txtMarketplace" Text='<%# Eval("marketplace") %>' Visible="false"></asp:TextBox>
                                                                </td>
                                                                <td>
                                                                    <small><asp:Label ID="Label1" runat="server" Text='<%# Eval("estabelecimento") %>'></asp:Label></small>
                                                                    <asp:TextBox runat="server" ID="txtEstabelecimento" Text='<%# Eval("estabelecimento") %>' Visible="false"></asp:TextBox>
                                                                </td>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-header bg-whitelabel1">
                        <h3 class="card-title">Seriais</h3>
                    </div>
                    <div class="card-body">
                                    ...
                                    <asp:Repeater runat="server" ID="rptConsulta" OnItemCommand="rptConsulta_OnItemCommand">
                                        <ItemTemplate>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <small>
                                                    <asp:TextBox runat="server" id="txtToken" Text='<%# DataBinder.Eval(Container.DataItem, "NUM_TOKEN")%>'></asp:TextBox>
                                                    </small>
                                                </td>
                                                <td>
                                                    <small>
                                                    <asp:TextBox runat="server" id="txtSerial" Text='<%# DataBinder.Eval(Container.DataItem, "NUM_SERIAL")%>'></asp:TextBox>
                                                    </small>
                                                </td>

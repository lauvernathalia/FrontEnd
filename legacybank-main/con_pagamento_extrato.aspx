<%@ Page Language="C#" AutoEventWireup="true" CodeFile="con_pagamento_extrato.aspx.cs" Inherits="con_pagamento_extrato" %>
                          ...
                          <div class="col-12">
                            <div class="card">
                              ...
                              <div class="card-body">
                                ...
                                <h2>Extrato</h2>
                                <h6></b>ATENÇÃO!</b> Período máximo de consulta 60 dias</h6>
                                            ...
                                            <tbody>
                                                <asp:Repeater runat="server" ID="rptConsulta">
                                                    <ItemTemplate>
                                                        <tr>
                                                            <td>
                                                                <small><asp:Label ID="Label6" runat="server" Text='<%# Eval("id") %>'></asp:Label></small>
                                                            </td>
                                                            <td>
                                                                <small><asp:Label ID="Label1" runat="server" Text='<%# Eval("data") %>'></asp:Label></small>
                                                            </td>
                                                            <td>
                                                                <small><asp:Label ID="Label2" runat="server" Text='<%# Eval("descricao") %>'></asp:Label></small>
                                                            </td>
                                                            <td>
                                                                <small><asp:Label ID="Label3" runat="server" Text='<%# Eval("valor") %>'></asp:Label></small>
                                                            </td>
                                                            <td>
                                                                <small><asp:Label ID="Label4" runat="server" Text='<%# Eval("saldo") %>'></asp:Label></small>
                                                            </td>
                                                            <td>
                                                                <a href="" onclick="javascript:openPopupWindow('con_pagamento_extrato_comprovante.aspx?id=<%# Funcoes.Encrypt(Eval("id").ToString()) %>', 'ExtratoComprovante', 1024, 800); return false;" class="btn btn-block btn-whitelabel1 m-1">
                                                                    Comprovante
                                                                </a>
                                                            </td>
                                                        </tr>

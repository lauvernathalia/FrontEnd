<%@ Page Language="C#" AutoEventWireup="true" CodeFile="con_bancos.aspx.cs" Inherits="con_bancos" %>
                                        ...
                                        <table id="tabConsulta" class="table table-bordered table-hover">
                                            ...
                                            <asp:Repeater runat="server" ID="rptConsulta" OnItemCommand="rptConsulta_OnItemCommand">
                                                <ItemTemplate>
                                                    ...
                                                    <tr>
                                                      <td>
                                                          <small><strong><%# DataBinder.Eval(Container.DataItem, "NOM_COD_ID")%></strong></small>
                                                      </td>
                                                      <td>
                                                        <a href="" onclick="javascript:openPopupWindow('cad_bancos.aspx?id=<%# Funcoes.Encrypt(DataBinder.Eval(Container.DataItem,"COD_ID").ToString()) %>', 'Bancos', 1024, 800); return false;" class="btn btn-sm btn-app">
                                                            <i class="fas fa-edit"></i> Editar
                                                        </a>
                                                      </td>

                                                      <td>
                                                          <small><strong><%# DataBinder.Eval(Container.DataItem, "NOM_BANCO")%></strong></small>
                                                      </td>
                                                    </tr>
                                                </ItemTemplate>
                                            </asp:Repeater>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="con_cobrancas_link_pagamento.aspx.cs" Inherits="con_cobrancas_link_pagamento" %>
                        ...
                        <div class="row mb-2">
                          <div class="col-sm-12">
                            <ol class="breadcrumb">
                              ...
                              <li class="breadcrumb-item active">Link de Pagamento</li>
                            </ol>
                          </div>
                        </div>
                          ...
                          <div class="col-12">
                            <div class="card">
                              ...
                              <div class="card-header bg-whitelabel1">
                                <h3 class="card-title">Cobranças - Link de Vendas</h3>
                              </div>
                              <div class="card-body">

                                <div class="row">
                                    <div class="col-sm-12">
                                        <h5 class="text-whitelabel1">Preencha os dados referentes ao Link de Pagamento</h5>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-12">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <h6 class="text-whitelabel1">Selecione as formas de pagamento que serão aceitas</h6>
                                    </div>
                                </div>
                                ...
                                <div class="row" style="display:none;">
                                    <div class="col-sm-12">
                                        <h6 class="text-whitelabel1">Preencha os dados do cartão de crédito</h6>
                                    </div>
                                </div>
                                ...
                                <div class="row" style="display:none;">
                                    <div class="col-sm-12">
                                        <h6 class="text-whitelabel1"><asp:Label runat="server" ID="lblBandeira" Text="" Visible="false"></asp:Label><asp:Image runat="server" id="imgBandeira" CssClass="img-fluid img-thumbnail mx-auto" style="max-width:50px;"></asp:Image></h6>
                                        
                                    </div>
                                </div>


                                <div class="row" runat="server" id="dvCartaoCredito" visible="true"  style="display:none;">
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            <label class="col-sm-12 col-form-label">No. Cartão</label>
                                            <asp:TextBox id="txtNumeroCartao" runat="server" class="form-control" 
                                                AutoPostBack="True" ontextchanged="txtNumeroCartao_TextChanged" ></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList id="ddlParcelas" runat="server" class="form-control">
							                    <asp:ListItem Value="01">Á VISTA</asp:ListItem>
							                    <asp:ListItem Value="02">02</asp:ListItem>
							                    <asp:ListItem Value="03">03</asp:ListItem>
							                    <asp:ListItem Value="04">04</asp:ListItem>
							                    <asp:ListItem Value="05">05</asp:ListItem>
                                ...
                                <div class="row" runat="server" id="dvEnvioEmailLabel" visible="false">
                                    <div class="col-sm-12">
                                        <h6 class="text-whitelabel1">Para enviar o link do boleto por e-mail basta informar os e-mail(s) separados por vírgula (,)</h6>
                                    </div>
                                </div>

                                <div class="row" runat="server" id="dvEnvioEmailText" visible="false">
                                    <div class="col-sm-12"  >
                                        <div class="form-group">
                                ...
                                <div class="row" runat="server" id="dvCartao" visible="false">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <asp:Label runat="server" ID="lblcartao" Text="Autorização"></asp:Label>
                                            <asp:TextBox runat="server" ID="txtcartao" CssClass="form-control" Enabled="false"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                              ...
                              <div class="card-footer">
                                  <asp:Button runat="server" ID="btnGerarVendaDireta" Text="Gerar Venda Direta" CssClass="btn btn-whitelabel1" onclick="btnGerarVendaDireta_Click" />
                              </div>
                            </div>
                          </div>
                        </div>

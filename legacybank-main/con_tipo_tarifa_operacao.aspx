<%@ Page Language="C#" AutoEventWireup="true" CodeFile="con_tipo_tarifa_operacao.aspx.cs" Inherits="con_tipo_tarifa_operacao" %>
                        ...
                        <div class="row mb-2">
                          <div class="col-sm-12">
                            <ol class="breadcrumb">
                              ...
                              <li class="breadcrumb-item active">Tipos Tarifas - Operações</li>
                            </ol>
                          </div>
                        </div>
                          ...
                          <div class="col-12">
                            <div class="card">
                              ...
                              <div class="card-header bg-whitelabel1">
                                <h3 class="card-title">TIPOS TARIFAS - OPERAÇÕES</h3>
                              </div>
                              <div class="card-body">
                        ...
                        <div class="row">
                          <div class="col-12">
                            <div class="card">
                              ...
                              <div class="card-header bg-whitelabel1">
                                <h3 class="card-title">TIPOS TARIFAS</h3>
                              </div>
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <tr>
                                                      ...
                                                      <td>
                                                        ...
                                                        <a href="" onclick="javascript:openPopupWindow('cad_tipo_tarifa_operacao.aspx?id=<%# Funcoes.Encrypt(DataBinder.Eval(Container.DataItem,"COD_ID").ToString())%>', 'EditarTipoTarifaOperacao', 1024, 800); return false;" class="btn btn-sm btn-app">
                                                      ...
                                                      <td>
                                                          <small><strong><%# DataBinder.Eval(Container.DataItem, "FLG_SIGLA")%></strong></small>
                                                      </td>

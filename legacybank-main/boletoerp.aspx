<%@ Page Language="C#" AutoEventWireup="true" CodeFile="boletoerp.aspx.cs" Inherits="boletoerp" %>
...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <center>
    <button class="btn btn-outline-secondary mb-3 mt-2" onclick="printDiv('dvReciboEstabelecimento')"><i class="fas fa-print" aria-hidden="true"></i>     Imprimir</button>
    </center>
    ...
    <table>
        <tr>
            <td class="sem-borda">
                ...
                <div class="row mt-2 mb-2">
                    <div class="col-6">
                        <h6><b><asp:Label runat="server" ID="Label2" Text="Vencimento"></asp:Label></b></h6>
                        <h6><asp:Label runat="server" ID="lblVencimentoTopo" Text=""></asp:Label></h6>
                    </div>
                    <div class="col-6">
                        <h6><b><asp:Label runat="server" ID="Label3" Text="Valor"></asp:Label></b></h6>
                        <h6><asp:Label runat="server" ID="lblValorTopo" Text=""></asp:Label></h6>
                    </div>
                </div>
                
                <div class="row mt-2 mb-2">
                    <div class="col-12">
                        <h6><b><asp:Label runat="server" ID="Label4" Text="Descrição"></asp:Label></b></h6>
                        <h6><asp:Label runat="server" ID="lblDescricaoTopo" Text=""></asp:Label></h6>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
    ...
    <div class="pagina" runat="server" id="dvReciboEstabelecimento" visible="false">

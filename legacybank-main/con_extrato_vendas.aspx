<%@ Page Language="C#" AutoEventWireup="true" CodeFile="con_extrato_vendas.aspx.cs" Inherits="con_extrato_vendas" %>
                        ...
                        <div class="row mb-2">
                          <div class="col-sm-12">
                            <ol class="breadcrumb">
                              ...
                              <li class="breadcrumb-item active">Extrato de Vendas</li>
                            </ol>
                          </div>
                        </div>
                          ...
                          <div class="row">
                            <div class="col-12">
                                <div class="card">
                                  ...
                                  <div class="card-header bg-whitelabel1">
                                    <h3 class="card-title">Extrato de Vendas</h3>
                                  </div>
                                                ...
                                                <asp:Repeater runat="server" ID="rptConsulta" OnItemCommand="rptConsulta_OnItemCommand" >
                                                    <ItemTemplate>
                                                        ...
                                                        <tr>
                                                          ...
                                                          <td>
                                                            <small class='<%# DataBinder.Eval(Container.DataItem, "NOM_FLG_RECURSO_COR")%>'><%# String.Format("{0:n2}",DataBinder.Eval(Container.DataItem, "NUM_VALOR"))%></small>
                                                          </td>
                                                          <td>

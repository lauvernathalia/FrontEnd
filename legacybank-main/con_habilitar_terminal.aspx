<%@ Page Language="C#" AutoEventWireup="true" CodeFile="con_habilitar_terminal.aspx.cs" Inherits="con_habilitar_terminal" %>
                ...
                <section class="content">
                    <div class="container-fluid" >
                        ...
                        <div class="row mb-2">
                          <div class="col-sm-12">
                            <ol class="breadcrumb">
                              <li class="breadcrumb-item"><a href="#">Maquininhas</a></li>
                              <li class="breadcrumb-item active">Habilitar Terminais</li>
                            </ol>
                          </div>
                        </div>
                          ...
                          <div class="col-12">
                            <div class="card">
                              ...
                              <div class="card-header bg-whitelabel1">
                                <h3 class="card-title">HABILITAR TERMINAIS</h3>
                              </div>
                              <div class="card-body">
                                ...
                                <div class="form-group row col-12">
                                    ...
                                    <div class="col-sm-4">
                                        <asp:TextBox id="txtFiltro" runat="server" class="form-control" placeholder="Serial ou Token"></asp:TextBox>
                                    </div>
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <tr>
                                                      ...
                                                      <td>
                                                        ...
                                                        <a href="" onclick="javascript:openPopupWindow('cad_habilitar_terminal.aspx?id=<%# Funcoes.Encrypt(DataBinder.Eval(Container.DataItem,"COD_ID").ToString())%>', 'HabilitarTerminal', 1024, 800); return false;" class="btn btn-sm btn-app">
                                                      ...
                                                      <td>
                                                          <small>
                                                          <%# DataBinder.Eval(Container.DataItem, "NUM_TOKEN")%>
                                                          </small>
                                                      </td>

                                                      <td>
                                                          <small>
                                                          <%# DataBinder.Eval(Container.DataItem, "NOM_PESSOAS_FJ")%>
                                                          </small>
                                                      </td>

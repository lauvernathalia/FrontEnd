<%@ Page Language="C#" AutoEventWireup="true" CodeFile="con_zoop_adm.aspx.cs" Inherits="events_con_zoop_adm" %>
                        ...
                        <div class="row mb-2">
                          <div class="col-sm-12">
                            <ol class="breadcrumb">
                              ...
                              <li class="breadcrumb-item active">Notificações ZOOP</li>
                            </ol>
                          </div>
                        </div>
                          ...
                          <div class="col-12">
                            <div class="card card-success">
                              ...
                              <div class="card-header">
                                <h3 class="card-title">Notificações ZOOP</h3>
                              </div>
                              <div class="card-body">
                                ...
                                <div class="form-group row col-12">
                                    ...
                                    <div class="col-sm-4">
                                        <asp:TextBox id="txtFiltro" runat="server" class="form-control" placeholder="Token ou Code"></asp:TextBox>
                                    </div>

                                    <div class="col-sm-6">
                                        <asp:Button runat="server" ID="btnPesquisar" CssClass="btn btn-whitelabel1" Text="Pesquisar" onclick="btnPesquisar_Click"/>
                                        <asp:Button runat="server" ID="btnProcessar" CssClass="btn btn-warning" Text="Processar Todos" onclick="btnProcessar_Click"/>
                                        ...
                                        <table id="example2" class="table table-bordered table-hover">
                                            ...
                                            <asp:Repeater runat="server" ID="rptConsulta" OnItemCommand="rptConsulta_OnItemCommand">
                                                <ItemTemplate>
                                                    ...
                                                    <tr>
                                                      <td>
                                                          <p style="max-width: 100ch;  overflow: hidden;  text-overflow: ellipsis;  white-space: nowrap;"><small><strong><%# DataBinder.Eval(Container.DataItem, "DES_JSON")%></strong></small></p>
                                                      </td>
                                                      <td>

                                                        <a href="" onclick="javascript:openPopupWindow('cad_zoop_adm.aspx?id=<%#DataBinder.Eval(Container.DataItem,"COD_ID")%>', 'NotificacoesZoop', 1024, 800); return false;" class="btn btn-sm btn-app">

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cad_estabelecimentos_padrao.aspx.cs" Inherits="cad_estabelecimentos_padrao" %>
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header bg-whitelabel1">
                        <h3 class="card-title">ESTABELECIMENTO - ID: <asp:Label runat="server" id="txtID" Text="(Automático)" Enabled="false"></asp:Label></h3>
                    </div>
                    <div class="card-body">
                        ...
                        <div runat="server" id="dvTipo" visible="true">
                            <h3><span class="float-center badge bg-whitelabel1">Tipo do Cadastro</span></h3>
                        ...
                        <div runat="server" id="dvFisica" visible="false">
                            ...
                            <div class="row">
                                <div class="col-sm-4"  >
                                    ...
                                    <asp:TextBox runat="server" ID="txtNascimentoPF" CssClass="form-control" placeholder="00/00/0000" required></asp:TextBox> 
                                    </div>
                                </div>
                                <div class="col-sm-4"  >
                                    <div class="form-group">

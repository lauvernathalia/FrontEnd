<%@ Page Language="C#" AutoEventWireup="true" CodeFile="con_assinatura_recorrente.aspx.cs" Inherits="con_assinatura_recorrente" %>
                        ...
                        <div class="row mb-2">
                          <div class="col-sm-12">
                            <ol class="breadcrumb">
                              ...
                              <li class="breadcrumb-item active">Vendas por Assinatura</li>
                            </ol>
                          </div>
                        </div>
                          ...
                          <div class="col-12">
                            ...
                            <div class="card">
                              ...
                              <div class="card-footer">
                                ...
                                <asp:Button runat="server" ID="btnNovo" CssClass="btn btn-whitelabel1 col-3" Text="Nova venda por Assinatura" onclick="btnNovo_Click"/>
                          ...
                          <div class="row">
                            <div class="col-12">
                                <div class="card">
                                  ...
                                  <div class="card-header bg-whitelabel1">
                                    <h3 class="card-title">Assinaturas Recorrentes</h3>
                                  </div>

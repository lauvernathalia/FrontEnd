<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cad_tipo_tarifa_operacao.aspx.cs" Inherits="cad_tipo_tarifa_operacao" %>
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header bg-whitelabel1">
                        <h3 class="card-title">TIPO TARIFAS - OPERAÇÕES</h3>
                    </div>
                    <div class="card-body">
                        <h3><span class="float-center badge bg-whitelabel1">Dados do Tipo Tarifas - Operações</span></h3>
                        ...
                        <h3><span class="float-center badge bg-whitelabel1">1. Tipo Tarifa - Operações</span></h3>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label class="col-sm-12 col-form-label">Tipo Tarifa Operação</label>
                                    <asp:TextBox id="txtTipoTarifaOperacao" runat="server" CssClass="form-control" ></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">

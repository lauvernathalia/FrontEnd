<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cad_carne.aspx.cs" Inherits="cad_carne" MaintainScrollPositionOnPostback="true" Async="true" %>
                          ...
                          <div class="card">
                            <div class="card-header bg-whitelabel1">
                              <h4 class="card-title text-white">
                                <a data-toggle="collapse" data-parent="#accordion" aria-expanded="false" href="#AbaCodigo" class="text-white">
                                    <i class="fas fa-barcode text-white"></i>          Carnê
                                </a>
                              </h4>
                            </div>

                            <div id="AbaCodigo" class="panel-collapse collapse show in">
                              <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-3">
                            ...
                            <div id="AbaCobranca" class="panel-collapse collapse show in">
                              <div class="card-body">
                                ...
                                <div class="row ">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <asp:Label runat="server" ID="Label4" Text="Descrição"></asp:Label>

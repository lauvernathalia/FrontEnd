<%@ Page Language="C#" AutoEventWireup="true" CodeFile="con_cartoes_solicitacao.aspx.cs" Inherits="con_cartoes_solicitacao" %>
                          ...
                          <div class="col-12">
                            <div class="card">
                              ...
                              <div class="card-header bg-whitelabel1">
                                <h3 class="card-title">Solicitar Cartão</h3>
                              </div>
                              <div class="card-body">

                                <h2>Solicitação Cartão Débito</h2>
                                <h6></b>ATENÇÃO!</b> Somente poderá ser solcitiado um cartão</h6>
                                <h6 class="text-whitelabel1">O custo do cartão é de R$ 20, que será descontado automaticamente do saldo</h6>

                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <asp:Label runat="server" ID="Label20" Text="Qual o nome a ser impresso no cartão?"></asp:Label>
                                            <asp:TextBox runat="server" ID="txtNomeCartao" CssClass="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                              ...
                              <div class="card-footer">
                                    <asp:Button runat="server" ID="btnSolicitar" Text="Solicitar" 
                                        CssClass="btn btn-whitelabel1" onclick="btnSolicitar_Click" />

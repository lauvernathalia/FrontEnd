<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cad_marketplaces_importar.aspx.cs" Inherits="cad_marketplaces_importar" %>
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header bg-whitelabel1">
                        <h3 class="card-title">MARKETPLACES IMPORTAR</h3>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row" runat="server" id="dvMarketplaces" visible="false">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label>Resposta Importação</label>
                                                    <asp:TextBox runat="server" ID="txtMarketplaces" Text="" CssClass="form-control"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row" runat="server" id="dvEstabelecimentos" visible="false">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <asp:TextBox runat="server" ID="txtEstabelecimentos" Text="" CssClass="form-control"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row"  runat="server" id="dvPlanos" visible="false">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label>Planos</label>
                                                    <asp:TextBox runat="server" ID="txtPlanos" Text="" CssClass="form-control"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <div class="form-check">
                                                      <asp:CheckBox CssClass="form-check-input" runat="server" id="ckbPlanos" 
                                                            Checked="True"/>
                                                      <label class="form-check-label text-whitelabel1">Clique aqui para importar junto os Planos do Marketplace</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <div class="form-check">
                                                      <asp:CheckBox CssClass="form-check-input" runat="server" id="ckbEstabelecimentos" 
                                                            Checked="True"/>
                                                      <label class="form-check-label text-whitelabel1">Clique aqui para importar junto os Estabelecimentos do Marketplace</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <asp:ListView ID="lsvMarketplacesCappta" runat="server">
                                                    <ItemTemplate>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <small><asp:Label ID="Label2" runat="server" Text='<%# Eval("portal") %>'></asp:Label></small>
                                                                    <asp:TextBox runat="server" ID="txtPortal" Text='<%# Eval("portal") %>' Visible="false"></asp:TextBox>
                                                                </td>
                                                                <td>
                                                                    <small><asp:Label ID="lblestabelecimentos" runat="server" Text='<%# Eval("estabelecimentos") %>'></asp:Label></small>
                                                                    <asp:TextBox runat="server" ID="txtestabelecimentos" Text='<%# Eval("estabelecimentos") %>' Visible="false"></asp:TextBox>
                                                                </td>
                                                                <td>
                                                                    <small><asp:Label ID="lblestabelecimentosportal" runat="server" Text='<%# Eval("estabelecimentosportal") %>'></asp:Label></small>
                                                                    <asp:TextBox runat="server" ID="txtestabelecimentosportal" Text='<%# Eval("estabelecimentosportal") %>' Visible="false"></asp:TextBox>
                                                                </td>

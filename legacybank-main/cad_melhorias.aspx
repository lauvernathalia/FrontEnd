<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cad_melhorias.aspx.cs" Inherits="cad_melhorias" %>
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header bg-whitelabel1">
                        <h3 class="card-title">SUGESTÃO MELHORIA</h3>
                    </div>
                    <div class="card-body">
                        <h3><span class="float-center badge bg-whitelabel1">Dados da Sugestão</span></h3>
                            ...
                            <div class="col-sm-2">
                                <div class="form-group">
                                    ...
                                    <asp:DropDownList runat="server" ID="ddlStatus" CssClass="form-control"  Enabled="false">
                                        ...
                                        <asp:ListItem Value="F">Feito</asp:ListItem>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label class="col-sm-12 col-form-label">Melhoria</label>
                                    <asp:TextBox id="txtMelhoria" runat="server" CssClass="form-control" ></asp:TextBox>

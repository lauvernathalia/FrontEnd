<%@ Page Language="C#" AutoEventWireup="true" CodeFile="con_historicos_vendas.aspx.cs" Inherits="con_historicos_vendas" Async="true" EnableSessionState="ReadOnly" MaintainScrollPositionOnPostback="true"  %>
                            ...
                            <div class="card">
                              ...
                              <div class="card-body">
                                <div class="row form-group col-12">
                                    ...
                                    <div class="col-sm-4">
                                        <asp:TextBox runat="server" ID="txtEstabelecimento" CssClass="form-control"></asp:TextBox>
                                        <asp:DropDownList runat="server" id="ddlEstabelecimentos" CssClass="form-control" Visible="false">
                                        </asp:DropDownList>
                                    </div>
                                ...
                                <div class="form-group row col-12">
						            ...
						            <div class="col-3">
                                        <asp:DropDownList runat="server" id="ddlTipoPagamento" CssClass="form-control" >
                                ...
                                <div class="row">
                                      <div class="col-sm-2 col-6">
                                        <div class="description-block border-right">
                                          ...
                                          <h5 class="description-header"><asp:Label runat="server" ID="lblVendas" Text="0"></asp:Label></h5>
                                      ...
                                      <div class="col-sm-2 col-6">
                                        <div class="description-block border-right">
                                          ...
                                          <h5 class="description-header"><asp:Label runat="server" ID="lblAprovadas" Text="0"></asp:Label></h5>
                                      ...
                                      <div class="col-sm-2 col-6">
                                        <div class="description-block border-right">
                                          ...
                                          <h5 class="description-header"><asp:Label runat="server" ID="lblSaldo" Text="0"></asp:Label></h5>
                                      ...
                                      <div class="col-sm-2 col-6">
                                        <div class="description-block border-right">
                                          ...
                                          <h5 class="description-header"><asp:Label runat="server" ID="lblTicket" Text="0"></asp:Label></h5>
                                      ...
                                      <div class="col-sm-2 col-6">
                                        <div class="description-block border-right">
                                          ...
                                          <h5 class="description-header"><asp:Label runat="server" ID="lblFalhadas" Text="0"></asp:Label></h5>
                            ...
                            <div class="col-12">
                                <div class="card">
                                  <div class="card-header text-center">
                                    <h3 class="text-whitelabel1"><strong>Histórico de Vendas</strong></h3>

                                    <div class="scrolling-wrapper-top">
                                  ...
                                  <div class="card-body scrolling-wrapper" style="overflow:auto; width: 100%; ">
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <asp:GridView ID="gvConsulta" runat="server" 
                                                        ...
                                                        onrowdatabound="gvConsulta_RowDataBound" AllowPaging="False" 
                                                        ...
                                                        <Columns>
                                                          ...
                                                          <asp:TemplateField HeaderText="ID">
                                                            ...
                                                            <asp:TextBox runat="server" ID="txtorigem" Text='<%# DataBinder.Eval(Container.DataItem, "FLG_ORIGEM")%>' Visible="false"></asp:TextBox>
                                                            ...
                                                            <asp:TextBox runat="server" ID="txtstatusoperacao" Text='<%# DataBinder.Eval(Container.DataItem, "FLG_STATUS_OPERACAO")%>' Visible="false"></asp:TextBox>
                                                          ...
                                                          <asp:TemplateField HeaderText="Comissão">
                                                            <ItemTemplate>
                                                                <small><%# String.Format("{0:n4}",DataBinder.Eval(Container.DataItem, "NUM_VALOR_COMISSAO"))%></small>
                                                            </ItemTemplate>
                                                          </asp:TemplateField>
                                                          <asp:TemplateField HeaderText="Comissão Mkt">
                                                            <ItemTemplate>
                                                                <small><%# String.Format("{0:n4}",DataBinder.Eval(Container.DataItem, "NUM_VALOR_COMISSAO_MKT"))%></small>
                                                            </ItemTemplate>
                                                          </asp:TemplateField>
                                                          <asp:TemplateField HeaderText="Comissão Rep">
                                                            <ItemTemplate>
                                                                <small><%# String.Format("{0:n4}",DataBinder.Eval(Container.DataItem, "NUM_VALOR_COMISSAO_REP"))%></small>
                                                            </ItemTemplate>
                                                          </asp:TemplateField>
                                                          ...
                                                          <asp:TemplateField HeaderText="Cancelar">
                                                            <ItemTemplate>
                                                                <asp:linkbutton ID="lkbVerificar" commandname="Cancelar" runat="server" text="Cancelar" ToolTip="Cancelar"  CommandArgument='<%# DataBinder.Eval(Container.DataItem, "COD_ID")%>'><i class="fas fa-ban text-danger"></i></asp:linkbutton>
                                                            </ItemTemplate>
                                                          </asp:TemplateField>

                                                          <asp:TemplateField HeaderText="Split">
                                                            <ItemTemplate>
                                                                <a href="" onclick="javascript:openPopupWindow('cad_historico_vendas_split.aspx?id=<%# Funcoes.Encrypt(DataBinder.Eval(Container.DataItem, "COD_ID").ToString()) %>', 'HistoricoVendaDetalhe', 1024, 800); return false;">
                                                                    <small><i class="fas fa-percent text-success"></i></small>
                                                                </a>
                                                            </ItemTemplate>
                                                          </asp:TemplateField>
                              ...
                              <div class="card-footer">
                                ...
                                <asp:Label ID="lblPagina" runat="server" CssClass=" float-right"></asp:Label>                              
                              </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        var topScroll = document.querySelector(".scrolling-wrapper-top");
        var mainScroll = document.querySelector(".scrolling-wrapper");

        // Sincroniza o scroll horizontal das duas barras
        ...
        // Ajusta a largura da barra superior para coincidir com o conteúdo
        document.querySelector(".scrolling-content").style.width = document.querySelector(".scrolling-wrapper").scrollWidth + "px";
    });
</script>

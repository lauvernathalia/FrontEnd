<%@ Page Language="C#" AutoEventWireup="true" CodeFile="con_motivo_suporte.aspx.cs" Inherits="con_motivo_suporte" %>
                        ...
                        <div class="row mb-2">
                          <div class="col-sm-12">
                            <ol class="breadcrumb">
                              ...
                              <li class="breadcrumb-item active">Tabela Motivos Suporte</li>
                            </ol>
                          </div>
                        </div>
                          ...
                          <div class="col-12">
                            ...
                            <div class="card">
                              ...
                              <div class="card-header bg-whitelabel1">
                                <h3 class="card-title">SUPORTE - MOTIVOS</h3>
                              </div>
                              <div class="card-body">
                              ...
                              <div class="card-footer" style="overflow:auto; width: 100%; ">
                                        ...
                                        <asp:Button runat="server" ID="btnNovo" CssClass="btn btn-whitelabel1 float-right" Text="(+) Novo Motivo Suporte" onclick="btnNovo_Click"/>
                                            ...
                                            <asp:Repeater runat="server" ID="rptConsulta" OnItemCommand="rptConsulta_OnItemCommand">
                                                <ItemTemplate>
                                                    ...
                                                    <tr>
                                                      ...
                                                      <td>
                                                        <a href="" onclick="javascript:openPopupWindow('cad_motivo_suporte.aspx?id=<%#DataBinder.Eval(Container.DataItem,"COD_ID")%>', 'MotivoSuporte', 1024, 800); return false;" class="btn btn-sm btn-app">

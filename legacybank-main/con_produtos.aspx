<%@ Page Language="C#" AutoEventWireup="true" CodeFile="con_produtos.aspx.cs" Inherits="con_produtos" %>
                          ...
                          <div class="col-12">
                            ...
                            <div class="card card-success">
                              ...
                              <div class="card-footer">
                                ...
                                <asp:Button runat="server" ID="btnNovo" CssClass="btn btn-whitelabel1 col-2" Text="Novo Produto" onclick="btnNovo_Click"/>
                                            ...
                                            <table id="tblConsulta" class="table table-bordered table-hover">
                                                ...
                                                <asp:Repeater runat="server" ID="rptConsulta" OnItemCommand="rptConsulta_OnItemCommand">
                                                    <ItemTemplate>
                                                        ...
                                                        <tr>
                                                          <td>
                                                            <a href="" onclick="javascript:openPopupWindow('cad_produtos.aspx?id=<%#DataBinder.Eval(Container.DataItem,"COD_ID")%>', 'ProdutosEdicao', 1024, 800); return false;" class="btn btn-sm btn-info">
                                                          ...
                                                          <td>
                                                              <small><strong><%# DataBinder.Eval(Container.DataItem, "NOM_PRODUTO")%></strong></small><br />
                                                          </td>

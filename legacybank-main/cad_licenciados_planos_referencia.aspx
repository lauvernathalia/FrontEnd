<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cad_licenciados_planos_referencia.aspx.cs" Inherits="cad_licenciados_planos_referencia" %>
                                        ...
                                        <table id="tbAcessos" class="table table-bordered table-hover">
                                            ...
                                            <asp:Repeater runat="server" ID="rptConsultaAcessos" 
                                                ...
                                                <ItemTemplate>
                                                    <tr>
                                                        <td>
                                                            <asp:TextBox runat="server" id="txtidplanosreferencia" Text='<%# DataBinder.Eval(Container.DataItem, "COD_ID")%>' visible="false"></asp:TextBox>
                                                            <asp:TextBox runat="server" id="txtacesso" Text='<%# DataBinder.Eval(Container.DataItem, "FLG_ACESSO")%>' visible="false"></asp:TextBox>

                                                            <small><strong><%# DataBinder.Eval(Container.DataItem, "NOM_PLANO_REFERENCIA")%></strong></small>
                                                        </td>
                                                        <td>

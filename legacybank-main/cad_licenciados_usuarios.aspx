<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cad_licenciados_usuarios.aspx.cs" Inherits="cad_licenciados_usuarios" %>
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header bg-whitelabel1">
                        <h3 class="card-title">LICENCIADOS USUÁRIOS</h3>
                    </div>
                    <div class="card-body">
                    ...
                    <div class="card-footer">
                        <asp:Button runat="server" ID="btnIncluir" CssClass="btn btn-whitelabel1" Text="Incluir" onclick="btnIncluir_Click" Enabled="true"/>
                            ...
                            <asp:Repeater runat="server" ID="rptConsultaUsuario" 
                                ...
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:linkbutton ID="lkbAcesso" CssClass="btn btn-secondary btn-sm" commandname="Acesso" runat="server" text="Acesso"  CommandArgument='<%# DataBinder.Eval(Container.DataItem, "COD_ID")%>' />                                            
                                        </td>

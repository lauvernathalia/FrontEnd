<%@ Page Language="C#" AutoEventWireup="true" CodeFile="con_melhorias.aspx.cs" Inherits="con_melhorias" %>
                ...
                <section class="content">
                    <div class="container-fluid" >
                        ...
                        <div class="row mb-2">
                          <div class="col-sm-12">
                            <ol class="breadcrumb">
                              <li class="breadcrumb-item"><a href="#">Melhorias</a></li>
                              <li class="breadcrumb-item active">Sugestão Melhoria</li>
                            </ol>
                          </div>
                        </div>
                          ...
                          <div class="col-12">
                            ...
                            <div class="card">
                              ...
                              <div class="card-header bg-whitelabel1">
                                <h3 class="card-title">SUGESTÃO DE MELHORIA</h3>
                              </div>
                              <div class="card-body">
                                ...
                                <div class="form-group row col-12">
                                    ...
                                    <div class="col-sm-3">
                                        <asp:DropDownList runat="server" id="ddlStatus" CssClass="form-control">
                                            ...
                                            <asp:ListItem Value="R">A Fazer</asp:ListItem>
                                            <asp:ListItem Value="Z">Fazendo</asp:ListItem>
                                            <asp:ListItem Value="F">Feitos</asp:ListItem>
                              ...
                              <div class="card-footer" style="overflow:auto; width: 100%; ">
                                        ...
                                        <asp:Button runat="server" ID="btnNovo" CssClass="btn btn-whitelabel1 float-right" Text="(+) Nova Sugestão de Melhoria" onclick="btnNovo_Click"/>
                                            ...
                                            <asp:Repeater runat="server" ID="rptConsulta" OnItemCommand="rptConsulta_OnItemCommand">
                                                <ItemTemplate>
                                                    ...
                                                    <tr>
                                                      ...
                                                      <td>
                                                        <a href="" onclick="javascript:openPopupWindow('cad_melhorias.aspx?id=<%# Funcoes.Encrypt(DataBinder.Eval(Container.DataItem, "COD_ID").ToString())%>', 'MelhoriasEdicao', 1024, 800); return false;" class="btn btn-sm btn-app">
                                                      ...
                                                      <td>
                                                          <small><strong><%# DataBinder.Eval(Container.DataItem, "NOM_MELHORIA")%></strong></small>
                                                      </td>
                                                      <td>
                                                      ...
                                                      <td class="text-center">
                                                        <a href="" onclick="javascript:openPopupWindow('cad_melhorias_interacoes.aspx?id=<%# Funcoes.Encrypt(DataBinder.Eval(Container.DataItem, "COD_ID").ToString())%>', 'MelhoriasInteracaoEdicao', 1024, 800); return false;" >

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cad_estabelecimentos_comercial.aspx.cs" Inherits="cad_estabelecimentos_comercial" %>
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header bg-whitelabel1">
                        <h3 class="card-title">CONFIGURAÇÕES COMERCIAIS</h3>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row" runat="server" id="dvDadosBancarios">
                            <div class="col-sm-2">
                                ...
                                <asp:DropDownList runat="server" id="ddlTipo" CssClass="form-control">
                                    <asp:ListItem Value="T">Todas as Operações</asp:ListItem>
                                    ...
                                    <asp:ListItem Value="P">Pix</asp:ListItem>
                                </asp:DropDownList>
                                </div>
                            </div>

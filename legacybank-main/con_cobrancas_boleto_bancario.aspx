<%@ Page Language="C#" AutoEventWireup="true" CodeFile="con_cobrancas_boleto_bancario.aspx.cs" Inherits="con_cobrancas_boleto_bancario" %>
                          ...
                          <div class="col-12">
                            <div class="card">
                              ...
                              <div class="card-header bg-whitelabel1">
                                <h3 class="card-title">Cobranças - Boletos Bancários</h3>
                              </div>
                              <div class="card-body">
                              ...
                              <div class="card-footer">
                                  <asp:Button runat="server" ID="btnGerarBoletoBancario" Text="Gerar Boleto Bancário" CssClass="btn btn-whitelabel1" onclick="btnGerarBoletoBancario_Click" />
                              </div>
                            </div>
                          </div>
                        </div>

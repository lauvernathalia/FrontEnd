<%@ Page Language="C#" AutoEventWireup="true" CodeFile="con_pagamento_boletos.aspx.cs" Inherits="con_pagamento_boletos" %>
                        ...
                        <div class="row mb-2">
                          <div class="col-sm-12">
                            <ol class="breadcrumb">
                              ...
                              <li class="breadcrumb-item active">Pagamento de Boletos</li>
                            </ol>
                          </div>
                        </div>
                          ...
                          <div class="col-12">
                            <div class="card">
                              ...
                              <div class="card-header bg-whitelabel1">
                                <h3 class="card-title">Pagamento de Boletos</h3>
                              </div>
                              <div class="card-body">
                                <h3><b>Saldo R$ </b><asp:Label runat="server" ID="lblSaldo" Text="0,00"></asp:Label></h3>

                                <h2>Realizar novo pagamento</h2>
                                <h6>A forma simples e direta de realizar todos os seus pagamentos</h6>
                                <div class="card card-outline col-12">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-10">
                                                <div class="form-group">
                                                    <asp:TextBox ID="txtLinhaDigitavel" runat="server" CssClass="form-control" placeholder="Digite o código de barras" ></asp:TextBox>
                                                </div>
                                            </div>

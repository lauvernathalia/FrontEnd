<%@ Page Language="C#" AutoEventWireup="true" CodeFile="con_suporte_geral.aspx.cs" Inherits="con_suporte_geral" %>
                                            ...
                                            <asp:Repeater runat="server" ID="rptConsulta" OnItemCommand="rptConsulta_OnItemCommand">
                                                <ItemTemplate>
                                                    ...
                                                    <tr>
                                                      ...
                                                      <td class="text-center">
                                                        <a href="" onclick="javascript:openPopupWindow('cad_suporte_interacoes.aspx?id=<%# Funcoes.Encrypt(DataBinder.Eval(Container.DataItem, "COD_ID").ToString())%>', 'SuporteInteracaoEdicao', 1024, 800); return false;" >

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="con_lancamentos_futuros.aspx.cs" Inherits="con_lancamentos_futuros" %>
                        ...
                        <div class="row mb-2">
                          <div class="col-sm-12">
                            <ol class="breadcrumb">
                              ...
                              <li class="breadcrumb-item active">Lançamentos Futuros</li>
                            </ol>
                          </div>
                        </div>
                          ...
                          <div class="row">
                            <div class="col-12">
                                <div class="card">
                                  ...
                                  <div class="card-header bg-whitelabel1">
                                    <h3 class="card-title">Lançamentos Futuros</h3>
                                  </div>
                                                ...
                                                <asp:Repeater runat="server" ID="rptConsulta">
                                                    <ItemTemplate>
                                                        ...
                                                        <tr>
                                                          ...
                                                          <td>
                                                            <small><%# String.Format("{0:dd/MM/yyyy HH:mm}",DataBinder.Eval(Container.DataItem, "DTA_PREVISAO"))%></small>
                                                          </td>
                                                          <td>
                                                          ...
                                                          <td>
                                                            <small><%# DataBinder.Eval(Container.DataItem, "NOM_OBJECT_ID_TRANSACAO")%></small>
                                                          </td>
                                                          <td>
                                                            <%# String.Format("{0:n2}",DataBinder.Eval(Container.DataItem, "NUM_VALOR"))%>
                                                          </td>

                                                          <td>
                                                            <a href="" onclick="javascript:openPopupWindow('cad_historico_vendas_detalhe.aspx?id=<%# Funcoes.Encrypt(DataBinder.Eval(Container.DataItem, "COD_ID_TRANSACOES").ToString()) %>', 'HistoricoVendaDetalhe', 1024, 800); return false;" class="btn btn-block btn-whitelabel1 m-1">
                                                                Detalhe
                                                            </a>
                                                          </td>
                                                        </tr>
        ...
        var table = $('#tblConsulta').DataTable({
            ...
            "footerCallback": function (row, data, start, end, display) {
                ...
                $(api.column(4).footer()).html(
                    'Total: R$ ' + totalPage.toLocaleString('pt-br', {minimumFractionDigits: 2}) + ' de R$ ' + total.toLocaleString('pt-br', {minimumFractionDigits: 2}) + ''
                );
            },

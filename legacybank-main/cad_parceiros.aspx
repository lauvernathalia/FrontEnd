<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cad_parceiros.aspx.cs" Inherits="cad_parceiros" %>
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header bg-whitelabel1">
                        <h3 class="card-title">PARCEIRO</h3>
                    </div>
                    <div class="card-body">
                        <h3><span class="float-center badge bg-whitelabel1">1. Dados do Parceiro</span></h3>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <h5 class="text-whitelabel1">Você pode importar os dados de cadastro digitando o CNPJ ou CPF e clicando em IMPORTAR</h5>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                <label>CPF/CNPJ Importar</label>
                                <asp:TextBox runat="server" id="txtCPFCNPJImportar" cssClass="form-control"  placeholder="Digite o CPF ou CNPJ a ser Importado"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <label>&nbsp;&nbsp;&nbsp;<br /></label><br />
                                <asp:Button runat="server" ID="btnImportar" CssClass="btn btn-whitelabel1" Text="Importar Dados do Parceiro" onclick="btnImportar_Click"/>
                            </div>
                        </div>

                        <div class="row">
                            <div class="col-sm-12">
                                <h5 class="text-whitelabel1">Ou pode preencher os dados a seguir e clicar em SALVAR</h5>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                <label>Telefone Parceiro<strong class="text-danger">*</strong></label>
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                <label>E-mail Parceiro<strong class="text-danger">*</strong></label>
                        ...
                        <div class="row">
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <label>Tipo do Parceiro<strong class="text-danger">*</strong></label>
                        ...
                        <h3><span class="float-center badge bg-whitelabel1">4. Dados Bancários</span></h3>
                        ...
                        <div class="row" runat="server" id="dvDadosBancarios">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                <label>Token Conta<strong class="text-danger">*</strong></label>
                                <asp:TextBox runat="server" ID="txtTokenConta" CssClass="form-control" Enabled="false"></asp:TextBox>
                                </div>
                            </div>

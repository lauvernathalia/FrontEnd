<%@ Page Language="C#" AutoEventWireup="true" CodeFile="con_bandeiras_adm.aspx.cs" Inherits="con_bandeiras_adm" %>
                        ...
                        <div class="row mb-2">
                          <div class="col-sm-12">
                            <ol class="breadcrumb">
                              ...
                              <li class="breadcrumb-item active">Bandeiras</li>
                            </ol>
                          </div>
                        </div>
                          ...
                          <div class="col-12">
                            <div class="card">
                              ...
                              <div class="card-header bg-whitelabel1">
                                <h3 class="card-title">BANDEIRAS</h3>
                              </div>
                              <div class="card-body">
                                ...
                                <div class="form-group row col-12">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <asp:Button runat="server" ID="btnNovo" CssClass="btn btn-whitelabel1 float-right" Text="(+) Nova Bandeira" onclick="btnNovo_Click"/>

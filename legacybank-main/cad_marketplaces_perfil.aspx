<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cad_marketplaces_perfil.aspx.cs" Inherits="cad_marketplaces_perfil" %>
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header bg-whitelabel1">
                        <h3 class="card-title">MARKETPLACE PERFIL</h3>
                    </div>
                    <div class="card-body">
                        <h3><span class="float-center badge bg-whitelabel1">1. Perfil do Marketplace</span></h3>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="con_simular_venda.aspx.cs" Inherits="con_simular_venda" %>
                        ...
                        <div class="row mb-2">
                          <div class="col-sm-12">
                            <ol class="breadcrumb">
                              ...
                              <li class="breadcrumb-item active">Simular venda</li>
                            </ol>
                          </div>
                        </div>
                            ...
                            <div class="card">
                              ...
                              <div class="card-body">
                                ...
                                <div class="form-group row col-12">
                                    ...
                                    <asp:TextBox ID="txtSimulacao" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                              ...
                              <div class="card-footer">
                                ...
                                <asp:Button runat="server" ID="btnNovo" CssClass="btn btn-whitelabel1 col-3" Text="Nova Simulação de Venda" onclick="btnNovo_Click"/>
                          ...
                          <div class="row">
                            <div class="col-12">
                                <div class="card">
                                  ...
                                  <div class="card-header bg-whitelabel1">
                                    <h3 class="card-title">Simular Venda</h3>
                                  </div>
                                                ...
                                                <asp:Repeater runat="server" ID="rptConsulta" OnItemCommand="rptConsulta_OnItemCommand">
                                                    <ItemTemplate>
                                                        <tr>
                                                          ...
                                                          <td><small><%# DataBinder.Eval(Container.DataItem, "COD_ID")%></small></td>
                                                          <td><small><%# String.Format("{0:dd/MM/yyyy}",DataBinder.Eval(Container.DataItem, "DTA_DATA"))%></small></td>
                                                          <td><small><%# DataBinder.Eval(Container.DataItem, "NOM_SIMULAR_VENDAS")%></small></td>
                                                          <td><small><%# DataBinder.Eval(Container.DataItem, "NOM_MODALIDADE")%></small></td>
                                                          <td><small><%# DataBinder.Eval(Container.DataItem, "NOM_BANDEIRA")%></small></td>
                                                        </tr>
                                                    </ItemTemplate>
                                                </asp:Repeater>

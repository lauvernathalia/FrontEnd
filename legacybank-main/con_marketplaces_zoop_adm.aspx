<%@ Page Language="C#" AutoEventWireup="true" CodeFile="con_marketplaces_zoop_adm.aspx.cs" Inherits="con_marketplaces_zoop_adm" %>
    ...
    <form id="frmPrincipal" runat="server">
        ...
        <div class="row">
            ...
            <div class="card card-success">
                ...
                <div class="form-group row col-12" runat="server" id="dvImportar" visible="false">
                    <div class="col-sm-4">
                        <label class="col-sm-12 col-form-label">ID</label>
                        <asp:Label id="lblID" runat="server" class="form-control"></asp:Label>
                    </div>
                    <div class="col-sm-8">
                        <label class="col-sm-12 col-form-label">Importar dados do Estabelecimento</label>
                        <asp:DropDownList runat="server" id="ddlImportar" CssClass="form-control" 
                            AutoPostBack="True" onselectedindexchanged="ddlImportar_SelectedIndexChanged">
                        </asp:DropDownList>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <asp:TextBox id="txtNome" runat="server" class="form-control" placeholder="Nome do Marketplace"></asp:TextBox>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <asp:TextBox id="txtSobrenome"  runat="server" class="form-control" 
                                placeholder="CPF/CNPJ"></asp:TextBox>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label class="col-sm-12 col-form-label">Documento Responsável</label>
                ...
                <div class="form-group row col-12">
                    <div class="col-sm-12">
                        <label class="col-sm-12 col-form-label">Token ID</label>
                        <asp:TextBox id="txtToken" runat="server" class="form-control" placeholder="Token Marketplace"></asp:TextBox>
                    </div>
                </div>
        ...
        <div class="row" runat="server" id="dvUsuarios" visible="false">
            <div class="col-12">
            <div class="card card-success">
                ...
                <div class="card-body">
                    <div class="form-group row col-12">
                        ...
                        <div class="col-sm-12">
                            <label class="col-sm-12 col-form-label">Usuários</label>
                            <div class="input-group">
                                <div class="custom-file">
                                <asp:TextBox runat="server" id="txtNomeUsuario" class="form-control" placeholder="Nome do Usuário"></asp:TextBox>
                                <asp:TextBox runat="server" id="txtEmail" class="form-control" placeholder="E-mail de login"></asp:TextBox>
                                <asp:TextBox runat="server" id="txtSenha" class="form-control" 
                                        placeholder="Senha de login" TextMode="Password"></asp:TextBox>
                                </div>
                                <div class="input-group-append">
                                <asp:Button runat="server" ID="btnIncluirUsuario" CssClass="btn btn-whitelabel1" Text="Incluir Usuário" onclick="btnIncluirUsuario_Click"/>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-footer">
                    <div class="row">
                        <div class="col-12">
                                <asp:Repeater runat="server" ID="rptConsultaUsuarios" 
                                    onitemcommand="rptConsultaUsuarios_ItemCommand" >
                                    <ItemTemplate>
                                            <strong>
                                            <span class="badge badge-secondary">
                                            <%# DataBinder.Eval(Container.DataItem, "NOM_LOGIN")%>
                                            <asp:linkbutton ID="lkbExcluirUsuario" CssClass="btn btn-secondary" commandname="Excluir" runat="server" text="X"  ToolTip="Excluir" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "COD_ID")%>'></asp:linkbutton>
                                            </span>
                                            </strong>
                                    </ItemTemplate>
                                </asp:Repeater>
        ...
        <div class="row" runat="server" id="dvPlanos" visible="false">
            <div class="col-12">
            <div class="card card-success">
                ...
                <div class="card-body">
                    <div class="form-group row col-12">
                        ...
                        <div class="col-sm-12">
                            <label class="col-sm-12 col-form-label">Planos</label>
                            <div class="input-group">
                                <div class="custom-file">
                                ...
                                <div class="input-group-append">
                                <asp:Button runat="server" ID="btnIncluirPlano" CssClass="btn btn-whitelabel1" Text="Incluir Plano" onclick="btnIncluirPlano_Click"/>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-footer">
                    <div class="row">
                        <div class="col-12">
                                <asp:Repeater runat="server" ID="rptConsultaPlanos" 
                                    onitemcommand="rptConsultaPlanos_ItemCommand" >
                                    <ItemTemplate>
                                            <strong>
                                            <span class="badge badge-secondary">
                                            <%# DataBinder.Eval(Container.DataItem, "NOM_TITULO_PLANO")%>
                                            <asp:linkbutton ID="lkbExcluirPlano" CssClass="btn btn-secondary" commandname="Excluir" runat="server" text="X"  ToolTip="Excluir" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "COD_ID")%>'></asp:linkbutton>
                                            </span>
                                            </strong>
                                    </ItemTemplate>
                                </asp:Repeater>
        ...
        <div class="row" runat="server" id="dvRepresentantes" visible="false">
            <div class="col-12">
            <div class="card card-success">
                ...
                <div class="card-body">
                    <div class="form-group row col-12">
                        <div class="col-sm-12">
                            <label class="col-sm-12 col-form-label">Representantes</label>
                            <div class="input-group">
                                <div class="custom-file">
                                <asp:DropDownList runat="server" id="ddlRepresentantes" CssClass="form-control">
                                </asp:DropDownList>                                              
                                </div>
                                <div class="input-group-append">
                                <asp:Button runat="server" ID="btnIncluirRepresentantes" 
                                        CssClass="btn btn-whitelabel1" Text="Incluir Representante" 
                                        onclick="btnIncluirRepresentantes_Click"/>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-footer">
                    <div class="row">
                        <div class="col-12">
                            <asp:Repeater runat="server" ID="rptConsultaRepresentantes" 
                                onitemcommand="rptConsultaRepresentantes_ItemCommand" >
                                <ItemTemplate>
                                            <strong>
                                            <span class="badge badge-secondary">
                                            <%# DataBinder.Eval(Container.DataItem, "NOM_RAZAOSOCIAL")%>
                                            <asp:linkbutton ID="lkbExcluirRepresentante" CssClass="btn btn-secondary" commandname="Excluir" runat="server" text="X"  ToolTip="Excluir" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "COD_ID")%>'></asp:linkbutton>
                                            </span>
                                            </strong>
                                </ItemTemplate>
                            </asp:Repeater>
        ...
        <div class="row" runat="server" id="dvEstabelecimentos" visible="false">
            <div class="col-12">
            <div class="card card-success">
                    ...
                    <div class="form-group row col-12">
                        <div class="col-sm-12">
                            ...
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                <asp:Button runat="server" ID="btnIncluirEstabelecimento" CssClass="btn btn-whitelabel1" Text="Incluir Estabelecimento" onclick="btnIncluirEstabelecimento_Click"/>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            <asp:Repeater runat="server" ID="rptConsultaEstabelecimentos" 
                                ...
                                <ItemTemplate>
                                            ...
                                            <span class="badge badge-secondary">
                                            <%# DataBinder.Eval(Container.DataItem, "NOM_RAZAOSOCIAL")%>
                                            <asp:linkbutton ID="lkbExcluirEstabelecimento" CssClass="btn btn-secondary" commandname="Excluir" runat="server" text="X"  ToolTip="Excluir" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "COD_ID")%>'></asp:linkbutton>
                                            </span>
                                            </strong>
                                </ItemTemplate>
                            </asp:Repeater>

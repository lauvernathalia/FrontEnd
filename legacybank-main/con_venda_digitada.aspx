<%@ Page Language="C#" AutoEventWireup="true" CodeFile="con_venda_digitada.aspx.cs" Inherits="con_venda_digitada" %>
                        ...
                        <div class="row mb-2">
                          <div class="col-sm-12">
                            <ol class="breadcrumb">
                              ...
                              <li class="breadcrumb-item active">Vendas por Digitação</li>
                            </ol>
                          </div>
                        </div>
                          ...
                          <div class="col-12">
                            ...
                            <div class="card card-success">
                              ...
                              <div class="card-footer">
                                ...
                                <asp:Button runat="server" ID="btnNovo" CssClass="btn btn-whitelabel1 col-3" Text="Nova venda por Digitação" onclick="btnNovo_Click"/>

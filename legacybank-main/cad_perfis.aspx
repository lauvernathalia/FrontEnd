<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cad_perfis.aspx.cs" Inherits="cad_perfis" ValidateRequest="true" %>
        ...
        <div class="row">
            ...
            <div class="card">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-2">
                        <div class="form-group">
                            <label class="col-sm-12 col-form-label">Padrão</label>

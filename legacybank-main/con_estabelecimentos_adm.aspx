<%@ Page Language="C#" AutoEventWireup="true" CodeFile="con_estabelecimentos_adm.aspx.cs" Inherits="dist_css_con_estabelecimentos_adm" %>
                                            ...
                                            <asp:Repeater runat="server" ID="rptConsulta" OnItemCommand="rptConsulta_OnItemCommand">
                                                <ItemTemplate>
                                                    ...
                                                    <tr>
                                                      ...
                                                      <td>
                    									<a href="cad_estabelecimentos_edicao_adm.aspx?id=<%# DataBinder.Eval(Container.DataItem, "COD_ID")%>">
                                                      ...
                                                      <td>
                                                          <small><%# DataBinder.Eval(Container.DataItem, "FLG_PORTAL")%></small>
                                                      </td>
                                                      <td>

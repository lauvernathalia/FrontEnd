<%@ Page Language="C#" AutoEventWireup="true" CodeFile="con_planos_adm.aspx.cs" Inherits="con_planos_adm" %>
                                            ...
                                            <asp:Repeater runat="server" ID="rptConsulta" OnItemCommand="rptConsulta_OnItemCommand">
                                                <ItemTemplate>
                                                    ...
                                                    <tr>
                                                      ...
                                                      <td>
                    									<a href="cad_planos_adm.aspx?id=<%# DataBinder.Eval(Container.DataItem, "COD_ID")%>" class="btn btn-sm btn-info">
                                                      ...
                                                      <td>
                    									<a href="cad_planos_adm.aspx?id=<%# DataBinder.Eval(Container.DataItem, "COD_ID")%>">

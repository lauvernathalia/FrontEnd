...
public partial class con_carne : System.Web.UI.Page
{
    ...
    private void ConsultaGeral()
    {
        ...
        SDAConsulta.SelectCommand.Parameters.Add("@FLG_TIPO", SqlDbType.Char).Value = 'N';
    ...
    {
        ClientScript.RegisterStartupScript(this.GetType(),    "NovaVendaCarne", "openPopupWindow('cad_carne.aspx?id=0','CarneEdicao',1024,800);", true);

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="con_tipo_tarifa.aspx.cs" Inherits="con_tipo_tarifa" %>
                        ...
                        <div class="row mb-2">
                          <div class="col-sm-12">
                            <ol class="breadcrumb">
                              ...
                              <li class="breadcrumb-item active">Tipos Tarifas</li>
                            </ol>
                          </div>
                        </div>
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <tr>
                                                      ...
                                                      <td>
                                                        ...
                                                        <a href="" onclick="javascript:openPopupWindow('cad_tipo_tarifa.aspx?id=<%# Funcoes.Encrypt(DataBinder.Eval(Container.DataItem,"COD_ID").ToString())%>', 'EditarTipoTarifa', 1024, 800); return false;" class="btn btn-sm btn-app">

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cad_bancos.aspx.cs" Inherits="cad_bancos" %>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label class="col-sm-12 col-form-label">Código Banco</label>
                            <asp:TextBox id="txtCodigo" runat="server" class="form-control" placeholder="Nome"></asp:TextBox>
                        </div>
                    </div>

                    <div class="col-sm-8">
                        <div class="form-group">
                            <label class="col-sm-12 col-form-label">Nome Banco</label>

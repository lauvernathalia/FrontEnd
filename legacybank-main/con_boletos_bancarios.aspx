<%@ Page Language="C#" AutoEventWireup="true" CodeFile="con_boletos_bancarios.aspx.cs" Inherits="con_boletos_bancarios" %>
                        ...
                        <div class="row mb-2">
                          <div class="col-sm-12">
                            <ol class="breadcrumb">
                              ...
                              <li class="breadcrumb-item active">Boletos Bancários</li>
                            </ol>
                          </div>
                        </div>
                          ...
                          <div class="col-12">
                            ...
                            <div class="card">
                              ...
                              <div class="card-footer">
                                ...
                                <asp:Button runat="server" ID="btnNovo" CssClass="btn btn-whitelabel1 col-3" Text="Nova venda por Boleto" onclick="btnNovo_Click"/>
                          ...
                          <div class="row">
                            <div class="col-12">
                                <div class="card">
                                  ...
                                  <div class="card-header bg-whitelabel1">
                                    <h3 class="card-title">Boletos Bancários</h3>
                                  </div>
                                            ...
                                            <table id="tblConsulta" class="table table-bordered table-hover">
                                                ...
                                                <asp:Repeater runat="server" ID="rptConsulta" OnItemCommand="rptConsulta_OnItemCommand">
                                                    <ItemTemplate>
                                                        ...
                                                        <tr>
                                                          <td>
                                                            <a href="" onclick="javascript:openPopupWindow('cad_boletos_bancarios.aspx?id=<%#Funcoes.Encrypt(DataBinder.Eval(Container.DataItem,"COD_ID").ToString())%>', 'BoletosBancariosEdicao', 1024, 800); return false;" class="btn btn-sm btn-info">
                                                          ...
                                                          <td>
                                                              <small><strong><%# String.Format("{0:n2}",DataBinder.Eval(Container.DataItem, "NOM_STATUS"))%> </strong></small>
                                                          </td>
                                                          <td>
                                                            <a href="" onclick="javascript:openPopupWindow('cad_historico_vendas_detalhe.aspx?id=<%# Funcoes.Encrypt(DataBinder.Eval(Container.DataItem, "COD_ID_TRANSACAO").ToString()) %>', 'HistoricoVendaDetalhe', 1024, 800); return false;" class="btn btn-block btn-whitelabel1 m-1">
                                                                Detalhe
                                                            </a>
                                                          </td>

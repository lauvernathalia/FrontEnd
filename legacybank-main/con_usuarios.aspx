<%@ Page Language="C#" AutoEventWireup="true" CodeFile="con_usuarios.aspx.cs" Inherits="con_usuarios" ValidateRequest="true" %>
                                        ...
                                        <table id="example2" class="table table-bordered table-hover">
                                            ...
                                            <asp:Repeater runat="server" ID="rptConsulta" OnItemCommand="rptConsulta_OnItemCommand">
                                                <ItemTemplate>
                                                    ...
                                                    <tr>
                                                      <td>
                                                        <a href="" onclick="javascript:openPopupWindow('cad_usuarios.aspx?id=<%# Funcoes.Encrypt(DataBinder.Eval(Container.DataItem,"COD_ID").ToString())%>', 'UsuariosEdicao', 1024, 800); return false;" class="btn btn-sm btn-info">
                                                      ...
                                                      <td>
                                                        <a href="" onclick="javascript:openPopupWindow('cad_usuarios_perfil.aspx?id=<%#DataBinder.Eval(Container.DataItem,"COD_ID")%>', 'UsuariosPerfil', 1024, 800); return false;" class="btn btn-sm btn-info">
                                                            <i class="fas fa-clipboard-check"></i>
                                                        </a>
                                                      </td>
                                                      <td>
                                                        <a href="" onclick="javascript:openPopupWindow('cad_usuarios_dashboard.aspx?id=<%#DataBinder.Eval(Container.DataItem,"COD_ID")%>', 'UsuariosDashboard', 1024, 800); return false;" class="btn btn-sm btn-info">

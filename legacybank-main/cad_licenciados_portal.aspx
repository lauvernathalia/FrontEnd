<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cad_licenciados_portal.aspx.cs" Inherits="cad_licenciados_portal" %>
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header bg-whitelabel1">
                        <h3 class="card-title">LICENCIADOS PORTAL</h3>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                <label>Título Domínio/URL<strong class="text-danger">*</strong></label>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                <label>Link QRCcode<strong class="text-danger">*</strong></label>
                                <asp:TextBox runat="server" ID="txtLinkQRCode" CssClass="form-control"></asp:TextBox> 
                                </div>
                            </div>
                        
                            <div class="col-sm-6">
                                <div class="form-group">
                                <label>Imagem QRCcode<strong class="text-danger">*</strong></label>
                    ...
                    <div class="card-footer">
                        ...
                        <asp:Button runat="server" ID="btnHSTS" CssClass="btn btn-info" Text="Segurança HSTS" onclick="btnHSTS_Click"/>

                        <asp:Button runat="server" ID="btnCmd" CssClass="btn btn-info" Text="CMD" onclick="btnCmd_Click" Visible="false"/>

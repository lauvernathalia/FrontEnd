<%@ Page Language="C#" AutoEventWireup="true" CodeFile="con_carne_boletos.aspx.cs" Inherits="con_carne_boletos" %>
            ...
            <div class="col-12">
                        ...
                        <div class="card m-2">
                            <div class="card-body" style="overflow:auto; width: 100%; ">
                                <h3 class="modal-title text-black text-center"><b class="text-whitelabel1">BOLETOS</b> DO CARNÊ</h3>
                                        ...
                                        <asp:Repeater runat="server" ID="rptConsulta">
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td>
                                                    <a href='<%# DataBinder.Eval(Container.DataItem, "NOM_BOLETO")%>' target="_blank" class="btn btn-whitelabel1 m-1">

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cad_licenciados_integracoes.aspx.cs" Inherits="cad_licenciados_integracoes" %>
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header bg-whitelabel1">
                        <h3 class="card-title">LICENCIADOS INTEGRAÇÕES</h3>
                    </div>
                    <div class="card-body">
                                        ...
                                        <table id="tbAcessos" class="table table-bordered table-hover">
                                            ...
                                            <asp:Repeater runat="server" ID="rptConsultaAcessos" 
                                                ...
                                                <ItemTemplate>
                                                    <tr>
                                                        <td>
                                                            <asp:TextBox runat="server" id="txtidintegracao" Text='<%# DataBinder.Eval(Container.DataItem, "COD_ID")%>' visible="false"></asp:TextBox>

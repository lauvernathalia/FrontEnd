<%@ Page Language="C#" AutoEventWireup="true" CodeFile="con_compradores.aspx.cs" Inherits="con_compradores" %>
                          ...
                          <div class="col-12">
                            ...
                            <div class="card">
                              ...
                              <div class="card-footer">
                                ...
                                <asp:Button runat="server" ID="btnNovo" CssClass="btn btn-whitelabel1 col-2" Text="Novo Comprador" onclick="btnNovo_Click"/>
                                            ...
                                            <table id="tblConsulta" class="table table-bordered table-hover">
                                                ...
                                                <asp:Repeater runat="server" ID="rptConsulta" OnItemCommand="rptConsulta_OnItemCommand">
                                                    <ItemTemplate>
                                                        ...
                                                        <tr>
                                                          <td>
                                                            <a href="" onclick="javascript:openPopupWindow('cad_compradores.aspx?id=<%#DataBinder.Eval(Container.DataItem,"COD_ID")%>', 'CompradoresEdicao', 1024, 800); return false;" class="btn btn-sm btn-info">
                                                          ...
                                                          <td>
                                                              <small><strong><%# DataBinder.Eval(Container.DataItem, "NOM_NOME")%> <%# DataBinder.Eval(Container.DataItem, "NOM_SOBRENOME")%></strong></small><br />
                                                          </td>

                                                          <td>
                                                              <small><strong><%# DataBinder.Eval(Container.DataItem, "NUM_CNPJCPF")%></strong></small><br />
                                                          </td>

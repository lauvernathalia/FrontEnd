<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cad_licenciados_planos.aspx.cs" Inherits="cad_licenciados_planos" %>
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header bg-whitelabel1">
                        <h3 class="card-title">LICENCIADOS PLANOS</h3>
                    </div>
                    <div class="card-body">
                                        ...
                                        <table id="tbAcessos" class="table table-bordered table-hover">
                                            ...
                                            <asp:Repeater runat="server" ID="rptConsultaAcessos" 
                                                ...
                                                <ItemTemplate>
                                                    <tr>
                                                        <td>
                                                            <asp:TextBox runat="server" id="txtidplano" Text='<%# DataBinder.Eval(Container.DataItem, "COD_ID")%>' visible="false"></asp:TextBox>
                                                            <asp:TextBox runat="server" id="txtacesso" Text='<%# DataBinder.Eval(Container.DataItem, "FLG_ACESSO")%>' visible="false"></asp:TextBox>

                                                            <small><strong><%# DataBinder.Eval(Container.DataItem, "NOM_PLANO")%></strong></small>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <asp:linkbutton ID="lkbBloquear" CssClass="btn btn-danger btn-sm" commandname="Bloquear" runat="server" text="Bloquear"  ToolTip="Bloquear" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "COD_ID_INTEGRACOES")%>'></asp:linkbutton>
                                                        </td>
                                                    </tr>
                                                </ItemTemplate>
                                            </asp:Repeater>

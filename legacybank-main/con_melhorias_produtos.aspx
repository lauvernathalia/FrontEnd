<%@ Page Language="C#" AutoEventWireup="true" CodeFile="con_melhorias_produtos.aspx.cs" Inherits="con_melhorias_produtos" %>
                ...
                <section class="content">
                    <div class="container-fluid" >
                        ...
                        <div class="row mb-2">
                          <div class="col-sm-12">
                            <ol class="breadcrumb">
                              <li class="breadcrumb-item"><a href="#">Solicitações</a></li>
                              <li class="breadcrumb-item active">Melhorias - Produtos</li>
                            </ol>
                          </div>
                        </div>
                          ...
                          <div class="col-12">
                            ...
                            <div class="card">
                              ...
                              <div class="card-header bg-whitelabel1">
                                <h3 class="card-title">MELHORIAS - PRODUTOS</h3>
                              </div>
                              <div class="card-body">
                              ...
                              <div class="card-footer" style="overflow:auto; width: 100%; ">
                                        ...
                                        <asp:Button runat="server" ID="btnNovo" CssClass="btn btn-whitelabel1 float-right" Text="(+) Nova Melhoria - Produto" onclick="btnNovo_Click"/>
                                            ...
                                            <asp:Repeater runat="server" ID="rptConsulta" OnItemCommand="rptConsulta_OnItemCommand">
                                                <ItemTemplate>
                                                    ...
                                                    <tr>
                                                      ...
                                                      <td>
                                                        <a href="" onclick="javascript:openPopupWindow('cad_bandeiras_adm.aspx?id=<%#DataBinder.Eval(Container.DataItem,"COD_ID")%>', 'Bandeiras', 1024, 800); return false;" class="btn btn-sm btn-app">
                                                            <i class="fas fa-edit"></i> Editar
                                                        </a>
                                                      </td>

                                                      <td>
                                                          <asp:Image runat="server" id="imgBandeira" CssClass="img-fluid img-thumbnail mx-auto" style="max-width:100px;" ImageUrl='<%# DataBinder.Eval(Container.DataItem, "NOM_IMAGEM")%>'></asp:Image>
                                                      ...
                                                      <td>
                                                          <small><%# DataBinder.Eval(Container.DataItem, "NUM_ORDEM")%></small>
                                                      </td>

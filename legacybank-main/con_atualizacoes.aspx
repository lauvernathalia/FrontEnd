<%@ Page Language="C#" AutoEventWireup="true" CodeFile="con_atualizacoes.aspx.cs" Inherits="con_atualizacoes" %>
                        ...
                        <div class="row mb-2">
                          <div class="col-sm-12">
                            <ol class="breadcrumb">
                              ...
                              <li class="breadcrumb-item active">Atualizações & Melhorias</li>
                            </ol>
                          </div>
                        </div>
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <tr>
                                                      ...
                                                      <td>
                                                        ...
                                                        <a href="" onclick="javascript:openPopupWindow('cad_atualizacoes.aspx?id=<%#DataBinder.Eval(Container.DataItem,"COD_ID")%>', 'Mensagens', 1024, 800); return false;" class="btn btn-sm btn-app">
                                                            <i class="fas fa-edit"></i> Editar
                                                        </a>
                                                      </td>

                                                      <td>
                                                          <small><%# DataBinder.Eval(Container.DataItem, "NOM_ATUALIZACAO")%></small>
                                                      </td>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cad_planos_referencia_importar.aspx.cs" Inherits="cad_planos_referencia_importar" %>
        ...
        <div class="row">
            ...
            <div class="col-12">
                ...
                <div class="card">
                        ...
                        <div class="tab-content" id="tbimportacaoContent">
                            <div class="tab-pane fade" runat="server" id="tbcappta" role="tabpanel" aria-labelledby="tbcapptatab">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table id="tblPlanosReferencia" class="table table-bordered table-hover">
                                            <thead>
                                            <tr>
                                                <th>Importar</th>
                                                <th>Código</th>
                                            ...
                                            <tbody>
                                                <asp:ListView ID="lsvPlanosReferencia" runat="server" 
                                                    OnItemCommand="lsvPlanosReferencia_ItemCommand">
                                                    <ItemTemplate>
                                                            <tr>
                                                                <td>
                            ...
                            <div class="tab-pane fade" runat="server" id="tbzoop" role="tabpanel" aria-labelledby="tbzooptab">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            <asp:TextBox runat="server" ID="txtJsonZoop" Text="" TextMode="MultiLine" Rows="5" CssClass="form-control" Visible="false"></asp:TextBox>
                                        </div>
                                        ...
                                        <table id="Table1" class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                <asp:ListView ID="lsvPlanosReferenciaZoop" runat="server" 
                                                    OnItemCommand="lsvPlanosReferenciaZoop_ItemCommand">
                                                    <ItemTemplate>
                                                            <tr>
                                                                <td>
                                                                    <asp:CheckBox runat="server" ID="ckbImportar" />
                    ...
                    <div class="card-footer">
                        <asp:Button runat="server" ID="btnFechar" CssClass="btn btn-danger" Text="Fechar" onclick="btnFechar_Click"/>
                    </div>
                </div>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="con_marketplaces_estabelecimentos_adm.aspx.cs" Inherits="con_marketplaces_estabelecimentos_adm" %>
                        ...
                        <div class="col-12">
                            <asp:Repeater runat="server" ID="rptConsultaEstabelecimentos" 
                                ...
                                <ItemTemplate>
                                            ...
                                            <asp:linkbutton ID="lkbExcluirEstabelecimentos" CssClass="btn btn-sm btn-secondary" commandname="Excluir" runat="server" text="X"  ToolTip="Excluir" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "COD_ID")%>'></asp:linkbutton>
                                            </span>
                                            </strong>
                                </ItemTemplate>
                            </asp:Repeater>                        </div>

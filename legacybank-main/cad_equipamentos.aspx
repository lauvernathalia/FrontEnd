<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cad_equipamentos.aspx.cs" Inherits="cad_equipamentos" %>
        ...
        <div class="row">
            ...
            <div class="card">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            <label class="col-sm-12 col-form-label">Token</label>
                            <asp:TextBox runat="server" id="txtToken" class="form-control"></asp:TextBox>
                        </div>
                    </div>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="con_carne.aspx.cs" Inherits="con_carne" %>
                        ...
                        <div class="row mb-2">
                          <div class="col-sm-12">
                            <ol class="breadcrumb">
                              ...
                              <li class="breadcrumb-item active">Carnês de Pagamento</li>
                            </ol>
                          </div>
                        </div>
                          ...
                          <div class="col-12">
                            ...
                            <div class="card">
                              ...
                              <div class="card-footer">
                                ...
                                <asp:Button runat="server" ID="btnNovo" CssClass="btn btn-whitelabel1 col-3" Text="Nova Venda por Carnê" onclick="btnNovo_Click"/>
                                <asp:Button CssClass="btn btn-whitelabel1 col-2 float-right" runat="server" id="Button2" Text="Exportar Excel" onclick="btnExportar_Click" />
                          ...
                          <div class="row">
                            <div class="col-12">
                                <div class="card">
                                  ...
                                  <div class="card-header bg-whitelabel1">
                                    <h3 class="card-title">Carnês de Pagamento</h3>
                                  </div>
                                            ...
                                            <table id="tblConsulta" class="table table-bordered table-hover">
                                                ...
                                                <asp:Repeater runat="server" ID="rptConsulta" OnItemCommand="rptConsulta_OnItemCommand">
                                                    <ItemTemplate>
                                                        ...
                                                        <tr>
                                                          <td>
                                                            <a href="" onclick="javascript:openPopupWindow('cad_carne.aspx?id=<%# Funcoes.Encrypt(DataBinder.Eval(Container.DataItem, "COD_ID").ToString()) %>', 'VendasEdicao', 1024, 800); return false;" class="btn btn-sm btn-info">
                                                          ...
                                                          <td>
                                                            <div class="row">
                                                                <div class="d-flex">
                                                                    <a href="" onclick="javascript:openPopupWindow('con_carne_boletos.aspx?id=<%# Funcoes.Encrypt(DataBinder.Eval(Container.DataItem, "COD_ID").ToString()) %>', 'VendasLinkDetalhe', 1024, 800); return false;" class="btn btn-sm btn-whitelabel1 m-1" title="Compartilhar">
                                                                        <small><i class="fas fa-share-alt"></i></small>
                                                                    </a>

                                                                    <a href="" onclick="javascript:openPopupWindow('con_carne_boletos.aspx?id=<%# Funcoes.Encrypt(DataBinder.Eval(Container.DataItem, "COD_ID").ToString()) %>', 'VendasLinkDetalhe', 1024, 800); return false;" class="btn btn-sm btn-whitelabel1 m-1">
                                                                        <small><i class="fas fa-print"></i></small>
                                                                    </a>
                                                                    ...
                                                                    <a href="" onclick="javascript:openPopupWindow('con_carne_boletos.aspx?id=<%# Funcoes.Encrypt(DataBinder.Eval(Container.DataItem, "COD_ID").ToString()) %>', 'VendasLinkDetalhe', 1024, 800); return false;" class="btn btn-sm btn-whitelabel1 m-1">
                                                                        <small><i class="fas fa-barcode"></i></small>
                                                                    </a>
                                                                </div>
                                                            </div>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cad_eventos_equipamentos.aspx.cs" Inherits="cad_eventos_equipamentos" %>
    ...
    <form id="frmPrincipal" runat="server">
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header bg-whitelabel1">
                        <h3 class="card-title">EVENTOS - EQUIPAMENTOS</h3>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-2">
                        ...
                        <div class="row">
                            <div class="col-sm-6"  >
                                <div class="form-group">
                                <label>Equipamento<strong class="text-danger">*</strong></label>
                                <asp:DropDownList runat="server" ID="ddlEquipamento" CssClass="form-control">
                                </asp:DropDownList>
                                </div>
                            </div>
                            <div class="col-sm-6"  >
                                <div class="form-group">
                                <label>Estabelecimento<strong class="text-danger">*</strong></label>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header bg-whitelabel1">
                        <h3 class="card-title">LISTA DE EQUIPAMENTOS E ESTABELECIMENTOS</h3>
                    </div>
                            ...
                            <asp:Repeater runat="server" ID="rptConsultaUsuario" 
                                ...
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td>
                                            <small><strong><%# DataBinder.Eval(Container.DataItem, "NOM_MODELO")%></strong></small>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                        <a href="" onclick="javascript:openPopupWindow('cad_eventos_equipamentos_vendas.aspx?id=<%# Funcoes.Encrypt(DataBinder.Eval(Container.DataItem, "COD_ID").ToString())%>', 'EventosEquipamentosVendas', 1024, 800); return false;" class="btn btn-sm btn-info">

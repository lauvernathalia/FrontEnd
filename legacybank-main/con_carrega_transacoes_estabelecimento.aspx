<%@ Page Language="C#" AutoEventWireup="true" CodeFile="con_carrega_transacoes_estabelecimento.aspx.cs" Inherits="con_carrega_transacoes_estabelecimento" %>
                ...
                <section class="content">
                    <div class="container-fluid" >
                        ...
                        <div class="row mb-2">
                          <div class="col-sm-12">
                            <ol class="breadcrumb">
                              <li class="breadcrumb-item"><a href="#">Operação Diária</a></li>
                          ...
                          <div class="col-12">
                            <div class="card">
                              ...
                              <div class="card-header bg-whitelabel1">
                                <h3 class="card-title">CARREGAR TRANSAÇÕES</h3>
                              </div>
                              <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label class="col-12 col-form-label">Transações a partir de</label>
						                    <div class="col-12">
                                 ...
                                 <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label class="col-sm-12 col-form-label">Retorno</label>
                                            <asp:TextBox runat="server" ID="txtJson" CssClass="form-control" rows="10" 
                                 ...
                                 <div class="row">
                                    <div class="col-sm-12">
                                        <asp:Button runat="server" ID="btnCarregar" CssClass="btn btn-whitelabel1 float-right" Text="Carregar" onclick="btnCarregar_Click"/>
                                    ...
                                    <div class="col-12">
                                        <table id="Table3" class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <asp:ListView ID="lsvTransacoes" runat="server">
                                                    <ItemTemplate>
                                                            <tr>
                                                                <td>
                                                                    <small><asp:Label ID="lblID" runat="server" Text='<%# Eval("id") %>'></asp:Label></small>
                                                                </td>
                                                                <td>
                                                                    <small><asp:Label ID="lblData" runat="server" Text='<%# Eval("data") %>'></asp:Label></small>
                                                                </td>
                                                                <td>
                                                                    <small><asp:Label ID="lblValor" runat="server" Text='<%# Eval("valor") %>'></asp:Label></small>
                                                                </td>
                                                            </tr>
                                                    </ItemTemplate>
                                                </asp:ListView>

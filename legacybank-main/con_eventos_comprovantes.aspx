<%@ Page Language="C#" AutoEventWireup="true" CodeFile="con_eventos_comprovantes.aspx.cs" Inherits="con_eventos_comprovantes" %>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <h3><span class="float-center badge bg-whitelabel1">Dados do Evento</span></h3>
                        ...
                        <h3><span class="float-center badge bg-whitelabel1">Dados Comprovante</span></h3>

                        <div class="row" runat="server" id="dvDadosComprovante">
                            <div class="col-sm-2">
                                <div class="form-group">
                                <label>Valor<strong class="text-danger">*</strong></label>
                                <asp:TextBox runat="server" ID="txtValor" CssClass="form-control" Text="0,0"></asp:TextBox>
                                </div>
                            </div>

                            <div class="col-sm-10">
                                <div class="form-group">
                                    <label>Arquivo comprovante (bmp, jpg, jpeg, png, pdf)<strong class="text-danger">*</strong></label>
                                                ...
                                                <ItemTemplate>
                                                    <tr>
                                                        ...
                                                        <td style="max-width:300px;">
                                                            <small><%# DataBinder.Eval(Container.DataItem, "NOM_ARQUIVO").ToString()%></small>
                                                        </td>

                                                        <td>
                                                              <a class="btn btn-sm btn-whitelabel1" href="" onclick="javascript:openPopupWindow('public_html/<%# DataBinder.Eval(Container.DataItem,"NOM_ARQUIVO").ToString()%>', 'EventosComprovantesVisualizar', 1024, 800); return false;"><i class="fas fa-eye"></i></a>                                                            
                                                        </td>

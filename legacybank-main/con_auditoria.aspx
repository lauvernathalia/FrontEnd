<%@ Page Language="C#" AutoEventWireup="true" CodeFile="con_auditoria.aspx.cs" Inherits="con_auditoria" %>
                            ...
                            <div class="card">
                              ...
                              <div class="card-body">
                                <div class="form-group row col-12">
                                    ...
                                    <label class="col-2 col-form-label">Licenciado</label>
						            <div class="col-2">
								        <asp:TextBox ID="txtLicenciado" runat="server" CssClass="form-control" ></asp:TextBox>
                                    </div>
                          ...
                          <div class="row">
                            <div class="col-12">
                                <div class="card">
                                  ...
                                  <div class="card-header bg-whitelabel1">
                                    <h3 class="card-title">Log de Acessos </h3>
                                  </div>
                                                ...
                                                <table id="tabConsulta" class="table table-bordered table-hover">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="titulo">Licenciado</th>
                                                            <th class="titulo">Usuário</th>
                                                            <th class="titulo">Tipo</th>
                                                            <th class="titulo">Login</th>
                                                            <th class="titulo">IP</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        <asp:Repeater runat="server" ID="rptConsulta">
                                                            <ItemTemplate>
                                                                <tr>
                                                                    <td>
                                                                        <small class="titulo"><%# DataBinder.Eval(Container.DataItem, "COD_ID")%></small>
                                                                    </td>

                                                                    <td>
                                                                        <small class="titulo"><%# String.Format("{0:dd/MM/yyyy}", DataBinder.Eval(Container.DataItem, "DTA_DATA"))%></small>
                                                                    </td>

                                                                    <td>
                                                                        <small class="titulo"><%# String.Format("{0:HH:mm:ss}", DataBinder.Eval(Container.DataItem, "DTA_DATA"))%></small>
                                                                    </td>

                                                                    <td>
                                                                        <small class="titulo"><%# DataBinder.Eval(Container.DataItem, "NOM_AUDITORIA")%></small>
                                                                    </td>
                                                                    <td>
                                                                        <small class="titulo"><%# DataBinder.Eval(Container.DataItem, "DES_AUDITORIA")%></small>
                                                                    </td>
                                                                    <td>
                                                                        <small class="titulo"><%# DataBinder.Eval(Container.DataItem, "NOM_LICENCIADO")%></small>
                                                                    </td>
                                                                    <td>
                                                                        <small class="titulo"><%# DataBinder.Eval(Container.DataItem, "NOM_PESSOA")%></small>
                                                                    </td>
                                                                    <td>
                                                                        <small class="titulo"><%# DataBinder.Eval(Container.DataItem, "NOM_FLG_TIPO")%></small>
                                                                    </td>
                                                                    <td>
                                                                        <small class="titulo"><%# DataBinder.Eval(Container.DataItem, "NOM_LOGIN")%></small>
                                                                    </td>
                                                                    <td>
                                                                        <small class="titulo"><%# DataBinder.Eval(Container.DataItem, "NUM_IP")%></small>
                                                                    </td>
                                                                </tr>
                                                            </ItemTemplate>
                                                        </asp:Repeater>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="con_pagamento_parcelado.aspx.cs" Inherits="con_pagamento_parcelado" %>
                        ...
                        <div class="row mb-2">
                          <div class="col-sm-12">
                            <ol class="breadcrumb">
                              ...
                              <li class="breadcrumb-item active">Pagamento Parcelado</li>
                            </ol>
                          </div>
                        </div>
                          ...
                          <div class="col-12">
                            <div class="card">
                              ...
                              <div class="card-header bg-whitelabel1">
                                <h3 class="card-title">Pagamento Parcelado</h3>
                              </div>
                              <div class="card-body">
                                ...
                                <h5><i class="icon fas fa-exclamation-triangle"></i> ATENÇÃO!</h5>
                                    Opção em processo de teste e liberação! Liberação Prevista para <b>25/09/2024</b><br />

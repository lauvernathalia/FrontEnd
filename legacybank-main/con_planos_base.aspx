<%@ Page Language="C#" AutoEventWireup="true" CodeFile="con_planos_base.aspx.cs" Inherits="con_planos_base" %>
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <tr>
                                                      ...
                                                      <td>
                                                        ...
                                                        <a href="" onclick="javascript:openPopupWindow('cad_planos_base.aspx?id=<%# Funcoes.Encrypt(DataBinder.Eval(Container.DataItem,"COD_ID").ToString())%>', 'PlanosBaseEdicao', 1024, 800); return false;" class="btn btn-sm btn-app">
                                                      ...
                                                      <td>
                                                          <small><%# DataBinder.Eval(Container.DataItem, "NOM_REFERENCIA_PLANO_REFERENCIA")%></small>
                                                      </td>

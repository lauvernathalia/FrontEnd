<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cad_estabelecimentos_api.aspx.cs" Inherits="cad_estabelecimentos_api" %>
    ...
    <form id="frmPrincipal" runat="server">
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header bg-whitelabel1">
                        <h3 class="card-title">ESTABELECIMENTO TOKENS API</h3>
                    </div>
                    <div class="card-body">
                    ...
                    <div class="card-footer">
                        <asp:Button runat="server" ID="btnIncluir" CssClass="btn btn-whitelabel1" Text="Incluir Novo Token" onclick="btnIncluir_Click"/>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header bg-whitelabel1">
                        <h3 class="card-title">LISTA DE TOKENS</h3>
                    </div>
                    <div class="card-body">
                        <table id="tbTokens" class="table table-bordered table-hover">
                            <thead>
                            <tr>
                                <th>ID</th>
                                <th>Token</th>
                            ...
                            <tbody>
                            <asp:Repeater runat="server" ID="rptConsultaTokens" 
                                    onitemcommand="rptConsultaTokens_ItemCommand">
                                <ItemTemplate>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <small><strong><%# DataBinder.Eval(Container.DataItem, "NOM_TOKEN_API")%></strong></small>
                                        </td>
                                        <td>
                                            <small><%# String.Format("{0:dd/MM/yyyy}",DataBinder.Eval(Container.DataItem, "DTA_CRIACAO"))%></small>
                                        </td>
                                        <td>
                                            <small><%# DataBinder.Eval(Container.DataItem, "FLAG_ATIVO")%></small>
                                        </td>
                                        <td>

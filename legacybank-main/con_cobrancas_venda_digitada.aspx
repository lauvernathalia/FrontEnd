<%@ Page Language="C#" AutoEventWireup="true" CodeFile="con_cobrancas_venda_digitada.aspx.cs" Inherits="con_cobrancas_venda_digitada" %>
                        ...
                        <div class="row mb-2">
                          <div class="col-sm-12">
                            <ol class="breadcrumb">
                              ...
                              <li class="breadcrumb-item active">Venda Digitada (Cartão de Crédito)</li>
                            </ol>
                          </div>
                        </div>
                          ...
                          <div class="col-12">
                            <div class="card">
                              ...
                              <div class="card-header bg-whitelabel1">
                                <h3 class="card-title">Cobranças - Venda Digitada (Cartão de Crédito)</h3>
                              </div>
                              <div class="card-body">

                                <div class="row">
                                    <div class="col-sm-12">
                                        <h5 class="text-whitelabel1">Preencha os dados referentes ao Cobrança</h5>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-12">
                                ...
                                <div class="row" runat="server" id="dvCartaoCredito" visible="true">
                                    <div class="col-sm-2">
                                        <div class="form-group">

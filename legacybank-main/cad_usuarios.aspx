<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cad_usuarios.aspx.cs" Inherits="cad_usuarios" ValidateRequest="true" %>
                    ...
                    <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-sm-5"  >
                                        ...
                                        <asp:TextBox runat="server" ID="txtNome" CssClass="form-control" placeholder="Nome do usuário" required></asp:TextBox> 
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-5"  >
                                        ...
                                        <asp:TextBox runat="server" ID="txtEmail" CssClass="form-control" placeholder="E-mail de Login" required></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-sm-2"  >
                                        <div class="form-group">
                                        <label>Ativo<strong class="text-danger">*</strong></label>
                                        <asp:DropDownList id="ddlAtivo" runat="server" class="form-control" >
                                ...
                                <div class="row">
                                    <div class="col-sm-6"  >
                                        ...
                                        <asp:TextBox runat="server" ID="txtSenha" CssClass="form-control" 
                                                placeholder="Digite a senha"  TextMode="Password" ></asp:TextBox> 
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <asp:TextBox runat="server" ID="txtSenhaConfirmar" CssClass="form-control" 
                                                placeholder="Repita a senha"  TextMode="Password" 

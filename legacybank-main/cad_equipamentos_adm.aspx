<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cad_equipamentos_adm.aspx.cs" Inherits="cad_equipamentos_adm" %>
    ...
    <form id="frmPrincipal" runat="server">
        ...
        <div class="row">
            ...
            <div class="card">
                ...
                <h3 class="card-title">Equipamentos</h3><br />
                ...
                <div class="row">
                    ...
                    <div class="col-sm-2">
                        <div class="form-group">
                            ...
                            <asp:DropDownList runat="server" id="ddlAdquirente" class="form-control"></asp:DropDownList>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <asp:DropDownList runat="server" id="ddlModelo" class="form-control"></asp:DropDownList>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label class="col-sm-12 col-form-label">Serial</label>
                            <asp:DropDownList runat="server" id="ddlSerial" class="form-control"></asp:DropDownList>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label class="col-sm-12 col-form-label">Chip 01</label>
                            <asp:TextBox id="txtChip01" runat="server" class="form-control" placeholder="Chip 01"></asp:TextBox>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label class="col-sm-12 col-form-label">Chip 02</label>
                            <asp:TextBox id="txtChip02" runat="server" class="form-control" placeholder="Chip 02"></asp:TextBox>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <asp:DropDownList runat="server" id="ddlLocal" class="form-control"></asp:DropDownList>
                        </div>
                    </div>
                    <div class="col-sm-2">
                        <div class="form-group">

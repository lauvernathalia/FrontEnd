<%@ Page Language="C#" AutoEventWireup="true" CodeFile="con_modelos_equipamentos.aspx.cs" Inherits="con_modelos_equipamentos" %>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row col-12">
                                        ...
                                        <div class="col-sm-6">
                                            <asp:TextBox id="txtModelo" runat="server" class="form-control" placeholder="Nome do Modelo"></asp:TextBox>
                                        </div>
                                            ...
                                            <asp:Repeater runat="server" ID="rptConsulta" OnItemCommand="rptConsulta_OnItemCommand">
                                                <ItemTemplate>
                                                    ...
                                                    <tr>
                                                      ...
                                                      <td>
                                                        <a href="" onclick="javascript:openPopupWindow('cad_modelos_equipamentos.aspx?id=<%# Funcoes.Encrypt(DataBinder.Eval(Container.DataItem, "COD_ID").ToString())%>', 'Chips', 1024, 800); return false;" class="btn btn-sm btn-whitelabel1">

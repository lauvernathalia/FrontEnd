<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cad_zoop_adm.aspx.cs" Inherits="cad_zoop_adm" %>
    ...
    <form id="frmPrincipal" runat="server">
        ...
        <div class="row">
            ...
            <div class="card">
                ...
                <h3 class="card-title">Notificação</h3><br />

                </div>
                <div class="card-body">

                <asp:TextBox runat="server" id="txtJSON" Rows="10" TextMode="MultiLine" Width="100%"></asp:TextBox>

                
                <asp:TextBox runat="server" id="txtRetorno" Rows="10" TextMode="MultiLine" Width="100%"></asp:TextBox>

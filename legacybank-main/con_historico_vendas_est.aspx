<%@ Page Language="C#" AutoEventWireup="true" CodeFile="con_historico_vendas_est.aspx.cs" Inherits="con_historico_vendas_est" %>
                            ...
                            <div class="card">
                              ...
                              <div class="card-body">
                                <div class="row form-group col-12">
                                    ...
                                    <div class="col-sm-4">
                                        <asp:TextBox id="txtEstabelecimento" runat="server" class="form-control" placeholder="Nome do Estabelecimento"></asp:TextBox>
                                    </div>
                                ...
                                <div class="form-group row col-12">
						            ...
						            <div class="col-3">
                                        <asp:DropDownList runat="server" id="ddlTipoPagamento" class="form-control" ></asp:DropDownList>
                                    </div>
                                            ...
                                            <asp:GridView ID="gvConsulta" runat="server" 
                                                ...
                                                <Columns>
                                                  ...
                                                  <asp:TemplateField HeaderText="Detalhe">
                                                    <ItemTemplate>
                                                        <a data-toggle="modal" href='#modal-detalhe<%# DataBinder.Eval(Container.DataItem, "COD_ID")%>' data-backdrop="static" style="display:none;">                                                                

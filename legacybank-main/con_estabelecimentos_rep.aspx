<%@ Page Language="C#" AutoEventWireup="true" CodeFile="con_estabelecimentos_rep.aspx.cs" Inherits="con_estabelecimentos_rep" %>
                            ...
                            <div class="card">
                              ...
                              <div class="card-body">
                                ...
                                <div class="form-group row col-12">
                                    ...
                                    <div class="col-sm-4">
                                        <asp:TextBox id="txtFiltro" runat="server" class="form-control" placeholder="Nome ou CNPJ/CPF"></asp:TextBox>
                                    </div>

                                    <div class="col-sm-6">
                                        <asp:Button runat="server" ID="btnPesquisar" CssClass="btn btn-whitelabel1" Text="Pesquisar" onclick="btnPesquisar_Click"/>
                                        <asp:Button runat="server" ID="btnNovo" CssClass="btn btn-whitelabel1 float-right" Text="(+) Novo Estabelecimento" onclick="btnNovo_Click"/>
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <tr>
                                                      ...
                                                      <td>
                                                        ...
                                                        <a href="" onclick="javascript:openPopupWindow('cad_estabelecimentos_rep.aspx?id=<%#DataBinder.Eval(Container.DataItem,"COD_ID")%>', 'Estabelecimentos', 1024, 800); return false;" class="btn btn-sm btn-app">
                                                            <i class="fas fa-edit"></i> Editar
                                                        </a>
                                                      </td>
                                                      <td>
                                                          <small><%# DataBinder.Eval(Container.DataItem, "NOM_NOME")%> <%# DataBinder.Eval(Container.DataItem, "NOM_SOBRENOME")%></small><br />

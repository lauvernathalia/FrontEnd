<%@ Page Language="C#" AutoEventWireup="true" CodeFile="linkpagamento.aspx.cs" Inherits="linkpagamento" %>
...
<body class="hold-transition sidebar-mini layout-fixed">
    <form id="frmQRCode" runat="server" visible="false">

        <div class="pagina" runat="server" id="dvTopoQRCode">
        <table>
            <tr>
                <td class="sem-borda">
                    <div class="row mt-2 mb-2">
                        <div class="col-6">
                            <h6><asp:Label runat="server" ID="lblComprador01" Text=""></asp:Label></h6>
                            <h6><asp:Label runat="server" ID="lblMensagemEntrada01" Text=""></asp:Label></h6>
                        </div>
                        <div class="col-6">
                            <center>
                            <img runat="server" id="imgLogoPrincipal01" class="img-fluid p-2 mt-2 mb-2 col-6" />
                            </center>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <h5><asp:Label runat="server" ID="Label4" Text="Como realizar o pagamento"></asp:Label></h5>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-10">
                            ...
                            <asp:LinkButton ID="lbkCopiar01" runat="server" CssClass="btn btn-default" ToolTip="copiar"><i class="fas fa-copy"></i></asp:LinkButton>
                            <asp:TextBox runat="server" ID="lblPixCopiaCola01" Text="" TextMode="MultiLine" Rows="3" CssClass="form-control"></asp:TextBox>
                        </div>
                        <div class="col-2">
                            <center>
                            <strong><i class="fab fa-pix"></i>  Pague usando o QRcode abaixo<br /></strong>
                            <img runat="server" class="img-fluid" id="imgQRcode01" src="" alt=""  />                                    
                            </center>
                        </div>
                    </div>
                </td>
    ...
    <form id="frmBoleto" runat="server" visible="false">
        <center>
